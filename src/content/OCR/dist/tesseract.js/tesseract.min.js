/*! For license information please see tesseract.min.js.LICENSE.txt */ ! function (t, r) {
    ...
    var t = {
            ...
            760: (t, r, e) => {
                ...
                var o = function (t) {
                    ...
                    function k(t, e) {
                        var n = e.method,
                            o = t.iterator[n];
                        if (o === r) return e.delegate = null, "throw" === n && t.iterator.return && (e.method = "return", e.arg = r, k(t, e), "throw" === e.method) || "return" !== n && (e.method = "throw", e.arg = new TypeError("The iterator does not provide a '" + n + "' method")), g;
                    ...
                    return b.prototype = w, i(E, "constructor", {
                        ...
                        return Object.setPrototypeOf ? Object.setPrototypeOf(t, w) : (t.__proto__ = w, l(t, f, "GeneratorFunction")), t.prototype = Object.create(E), t
                    }, t.awrap = function (t) {
                        return {
                            __await: t
                        }
                    }, S(j.prototype), l(j.prototype, u, (function () {
                        return this
                    ...
                    }, S(E), l(E, f, "Generator"), l(E, c, (function () {
                        return this
            ...
            793: (t, r, e) => {
                ...
                function o() {
                    ...
                    function E(t, r) {
                        var e = r.method,
                            n = t.iterator[e];
                        if (void 0 === n) return r.delegate = null, "throw" === e && t.iterator.return && (r.method = "return", r.arg = void 0, E(t, r), "throw" === r.method) || "return" !== e && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + e + "' method")), p;
                        ...
                        var t = a(o().mark((function t(r, e, n) {
                            ...
                            return o().wrap((function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 2:
                                        return i = t.sent, t.abrupt("return", i.recognize(r).finally(a(o().mark((function t() {
                                            return o().wrap((function (t) {
                                                for (;;) switch (t.prev = t.next) {
                                                    case 0:
                        ...
                        var t = a(o().mark((function t(r, e) {
                            ...
                            return o().wrap((function (t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 2:
                                        return n = t.sent, t.abrupt("return", n.detect(r).finally(a(o().mark((function t() {
                                            return o().wrap((function (t) {
                                                for (;;) switch (t.prev = t.next) {
                                                    case 0:
                ...
                t.exports = function () {
                    ...
                    var c = function () {
                        ...
                        y = function (r, c) {
                            return new Promise((function (s, h) {
                                ...
                                n.push(function () {
                                    var t = u(i().mark((function t(u) {
                                        return i().wrap((function (t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return n.shift(), e[u.id] = y, t.prev = 2, t.t0 = s, t.next = 6, u[r].apply(o, [].concat(function (t) {
                                                ...
                                                case 13:
                                                    return t.prev = 13, delete e[u.id], p(), t.finish(13);
                                                case 17:
                                                case "end":
                                                    return t.stop()
                                            }
                                ...
                                }()), l("[".concat(t, "]: Add ").concat(y.id, " to JobQueue")), l("[".concat(t, "]: JobQueue length=").concat(n.length)), p()
                            }))
                        },
                        v = function () {
                    ...
                    return {
                        addWorker: function (e) {
                            return r[e.id] = e, l("[".concat(t, "]: Add ").concat(e.id)), l("[".concat(t, "]: Number of workers=").concat(c())), p(), e.id
                        },
                        addJob: v,
                        terminate: d,
            ...
            311: (t, r, e) => {
                ...
                t.exports = h(i().mark((function t() {
                    var r, e, n, c, f, s, b, P, k, _, T, N, A, G, I, F, R, D, M, C, U, Y, B, z, H, K, W, J, V, Z, Q, q, X, $, tt, rt, et, nt, ot, it, at = arguments;
                    return i().wrap((function (t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                return r = at.length > 0 && void 0 !== at[0] ? at[0] : "eng", e = at.length > 1 && void 0 !== at[1] ? at[1] : m.LSTM_ONLY, n = at.length > 2 && void 0 !== at[2] ? at[2] : {}, c = at.length > 3 && void 0 !== at[3] ? at[3] : {}, f = g("Worker", j), s = p(u(u({}, w), n)), b = s.logger, P = s.errorHandler, k = l(s, o), _ = {}, T = {}, N = "string" == typeof r ? r.split("+") : r, A = e, G = c, I = [m.DEFAULT, m.LSTM_ONLY].includes(e) && !k.legacyCore, D = new Promise((function (t, r) {
                                    R = t, F = r
                                })), M = function (t) {
                                    F(t.message)
                                }, (C = x(k)).onerror = M, j += 1, U = function (t, r) {
                                    _[t] = r
                                }, Y = function (t, r) {
                                    T[t] = r
                                }, B = function (t) {
                                    ...
                                    return B(v({
                                        ...
                                        payload: {
                                            ...
                                            options: {
                                                ...
                                                gzip: k.gzip,
                                                lstmOnly: [m.DEFAULT, m.LSTM_ONLY].includes(A) && !k.legacyLang
                                            }
                                        }
                                    }))
                                }, q = function () {
                                    ...
                                    if (I && [m.TESSERACT_ONLY, m.TESSERACT_LSTM_COMBINED].includes(r)) throw Error("Legacy model requested but code missing.");
                                    var o = r || A;
                                    A = o;
                                    var i = e || G;
                                    G = i;
                                    ...
                                    var t = h(i().mark((function t(r) {
                                        ...
                                        return i().wrap((function (t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return e = a.length > 1 && void 0 !== a[1] ? a[1] : {}, n = a.length > 2 && void 0 !== a[2] ? a[2] : {
                                                        blocks: !0,
                                                        text: !0,
                                                        hocr: !0,
                                                        tsv: !0
                                                ...
                                                case 8:
                                                    return t.t3 = t.sent, t.t4 = e, t.t5 = n, t.t6 = {
                                                        image: t.t3,
                                                        options: t.t4,
                                                        output: t.t5
                                                    }, t.t7 = {
                                    ...
                                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Tesseract OCR Result",
                                        ...
                                        e = arguments.length > 2 ? arguments[2] : void 0;
                                    return console.log("`getPDF` function is depreciated. `recognize` option `savePDF` should be used instead."), B(v({
                                        id: e,
                                        action: "getPDF",
                                        payload: {
                                            title: t,
                                    ...
                                    var t = h(i().mark((function t(r, e) {
                                        return i().wrap((function (t) {
                                            for (;;) switch (t.prev = t.next) {
                                                ...
                                                case 2:
                                                    return t.t0 = B, t.t1 = v, t.t2 = e, t.next = 7, E(r);
                                                case 7:
                                    ...
                                    var t = h(i().mark((function t() {
                                        return i().wrap((function (t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return null !== C && (L(C), C = null), t.abrupt("return", Promise.resolve());
                                                case 2:
                                                case "end":
                                                    return t.stop()
                                            }
                                    ...
                                    if ("resolve" === n) {
                                        ...
                                        if (T[a](i), "load" === o && F(i), !P) throw Error(i);
                                        P(i)
                                    } else "progress" === n && b(u(u({}, i), {}, {
                                        userJobId: e
                                    }))
                                })), it = {
                                    id: f,
                                    ...
                                    return R(it)
                                })).catch((function () {})), t.abrupt("return", D);
                            case 40:
                            case "end":
                                return t.stop()
                        }
            ...
            129: (t, r, e) => {
                ...
                t.exports = function (t) {
                    var r = {};
                    return "undefined" != typeof WorkerGlobalScope ? r.type = "webworker" : o() ? r.type = "electron" : "object" === ("undefined" == typeof document ? "undefined" : n(document)) ? r.type = "browser" : "object" === ("undefined" == typeof process ? "undefined" : n(process)) && (r.type = "node"), void 0 === t ? r : r[t]
                }
            },
            313: t => {
            ...
            676: t => {
                t.exports = function (t) {
                    var r, e = t.workerPath,
                        n = t.workerBlobURL;
                        console.warn('创建worker, workerPath:', e)
                    if (Blob && URL && n) {
    ...
    return e.nmd = t => (t.paths = [], t.children || (t.children = []), t), e(352)
})()));
