...
!function() {
    ...
    class t extends Promise {
        constructor(t) {
            ...
            this._s = "pending",
            this.resolve = t => {
                this.isPending && (e(t) ? this.task = t : (this._s = "fulfilled",
                r(t)))
            }
            ,
            this.reject = e => {
                this.isPending && (this._s = "rejected",
                n(e))
            }
            ,
            this.task = t
        ...
        set task(t) {
            let r;
            this._task = t,
            e(t) ? r = t : "function" == typeof t && (r = new Promise(t)),
            r && (async () => {
                try {
                    const e = await r;
    ...
    const r = "undefined" == typeof self
      , n = r ? {} : self;
    let o, i, a, s, c;
    "undefined" != typeof navigator && (o = navigator,
    i = o.userAgent,
    a = o.platform,
    s = o.mediaDevices),
    function() {
        if (!r) {
            ...
            "Linux" == s && -1 != i.indexOf("Windows NT") && (s = "HarmonyOS"),
            c = {
                browser: r,
                version: n,
                OS: s
    ...
    "undefined" != typeof WebAssembly && i && (!/Safari/.test(i) || /Chrome/.test(i) || /\(.+\s11_2_([2-6]).*\)/.test(i)),
    s && s.getUserMedia;
    ...
    var O = {
        ...
        _initStorage: function(e) {
            ...
            return Promise.all(i).then((function() {
                ...
                return r.db = e,
                D(r, t._defaultConfig.version) ? E(r) : e
            }
            )).then((function(e) {
                r.db = o.db = e,
                t._dbInfo = r;
        ...
        setItem: function(e, t, r) {
            ...
            var o = new Promise((function(r, o) {
                ...
                n.ready().then((function() {
                    return i = n._dbInfo,
                    "[object Blob]" === v.call(t) ? S(i.db).then((function(e) {
                        return e ? t : (r = t,
            ...
            e.name) {
                ...
                r = e.storeName ? t.then((t => {
                    ...
                    return i.then((e => {
                        ...
                        throw (x(e, t) || Promise.resolve()).catch(( () => {}
                        )),
                        t
                    }
                    ))
                ...
                r = Promise.reject("Invalid arguments");
            return f(r, t),
            r
        }
    };
    ...
    var A = {
        ...
        setItem: function(e, t, r) {
            e = h(e);
            const n = this.ready().then(( () => (void 0 === t && (t = null),
            R.get(this._dbInfo.keyPrefix).set(e, t),
            t)));
            return f(n, r),
            n
        },
    ...
    const U = (e, t) => {
        ...
        let n = 0;
        for (; n < r; ) {
            if ((o = e[n]) === (i = t) || "number" == typeof o && "number" == typeof i && isNaN(o) && isNaN(i))
                return !0;
            n++
        }
        var o, i;
    ...
    function G() {
        for (let e = 1; e < arguments.length; e++) {
            ...
            if (t)
                for (let e in t)
                    t.hasOwnProperty(e) && (B(t[e]) ? arguments[0][e] = t[e].slice() : arguments[0][e] = t[e])
        }
        return arguments[0]
    }
    class Z {
            ...
            for (let e in L)
                if (L.hasOwnProperty(e)) {
                    const t = L[e]
                      , r = t._driver;
                    this[e] = r,
                    W[r] || this.defineDriver(t)
                }
            this._defaultConfig = G({}, V),
            this._config = G({}, this._defaultConfig, e),
            ...
            const n = new Promise((function(t, r) {
                try {
                    ...
                    for (let t = 0, n = i.length; t < n; t++) {
                        const n = i[t];
                        if ((!U(H, n) || e[n]) && "function" != typeof e[n])
                            return void r(o)
                    }
                    const a = function() {
                        const t = function(e) {
                            return function() {
                                const t = new Error(`Method ${e} is not implemented by the current driver`)
                                  , r = Promise.reject(t);
                                return f(r, arguments[arguments.length - 1]),
                                r
                            }
                        };
                    ...
                    a();
                    const s = function(r) {
                        W[n] && console.info(`Redefining LocalForage driver: ${n}`),
                        W[n] = e,
                        F[n] = r,
                        t()
                    };
        ...
        ready(e) {
            const t = this
              , r = t._driverSet.then(( () => (null === t._ready && (t._ready = t._initDriver()),
            t._ready)));
            return m(r, e, e),
            r
        }
        setDriver(e, t, r) {
            ...
            return this._driverSet = s.then(( () => {
                    ...
                    n._initDriver = function(e) {
                        return function() {
                            ...
                            return function r() {
                                ...
                                return n._driverSet = Promise.reject(o),
                                n._driverSet
                            }()
                        }
                    }(o)
                ...
                return n._driverSet = Promise.reject(e),
                n._driverSet
            }
            )),
    ...
    Date.prototype.kUtilFormat = function(e) {
        ...
        for (let r in t)
            new RegExp("(" + r + ")").test(e) && (e = e.replace(RegExp.$1, 1 == RegExp.$1.length ? t[r] : ("000" + t[r]).substr(("000" + t[r]).length - RegExp.$1.length)));
        return e
    }
    ;
    let K = e => {
        let r, o, i, a, s, c, d, u, f, m, h, p, y, g, b, v, w, _, S, I, C, x, k, P, E = n.btoa, D = n.atob, T = e.bd, N = e.dm, M = ["https://mlts.dynamsoft.com/", "https://slts.dynamsoft.com/"], O = !1, R = Promise.resolve(), j = e.log && ( (...t) => {
            try {
                e.log.apply(null, t)
            } catch (e) {
                setTimeout(( () => {
        ...
        }, W = () => n[U(B.c)][U(B.e)][U(B.f)]("raw", new Uint8Array(B.a.concat(B.b, B.d, B.k)), U(B.g), !0, [U(B.h), U(B.i)]), F = async e => {
        ...
        let G, Z, K, q, X = async () => {
            ...
            try {
                ...
                if (!e) {
                    ...
                    e = await t.getItem(S),
                    e && await _.setItem(S, e)
                }
                e && ([d,g] = JSON.parse(await L(e)))
            } catch (e) {}
            try {
                null == d && (d = H(),
                _.setItem(S, await z(JSON.stringify([d, null]))))
            } catch (e) {}
            G.resolve()
        }
        , Q = async e => {
            ...
            try {
                ...
                let l = await Promise.race([(async () => {
                        ...
                        if (e && !e.ok)
                            try {
                                ...
                                if (t) {
                                    let e = JSON.parse(t);
                                    e.errorCode && (a = e,
                                    e.errorCode > 100 && e.errorCode < 200 && (s = null,
                                    c = !0,
                                    l = !0))
                                }
                            } catch (e) {}
                    ...
                    a && 151 == a.errorCode && (_.removeItem(S),
                    _.removeItem(I),
                    d = H(),
                    t.cu = d,
                    g = void 0,
                    i = "auth/?ext=" + encodeURIComponent(E(JSON.stringify(t))),
                    r = await Promise.race([fetch(M[0] + i, {
                        headers: n,
                        mode: "cors"
                    }), new Promise(( (e, t) => setTimeout(t, 3e4)))]),
                    ...
                    ( () => {
                        if (!r || !r.ok) {
                            let e;
                            l && _.setItem(I, ""),
                            a ? 111 == a.errorCode ? e = a.message : (e = a.message.trim(),
                            e.endsWith(".") || (e += "."),
                            e = m ? `An error occurred during authorization: ${e} [Contact Dynamsoft](https://www.dynamsoft.com/company/contact/) for more information.` : `An error occurred during authorization: ${e} Contact the site administrator for more information.`) : e = m ? $.publicTrialFailConnect : $.failConnect;
                            let t = Error(e);
                            throw a && a.errorCode && (t.ltsErrorCode = a.errorCode),
                            t
                        }
                    }
                    )();
                    ...
                    let r;
                    r = m ? $.publicTrialNetworkTimeout : $.networkTimeout,
                    setTimeout(( () => t(new Error(r))), s ? 3e3 : 15e3)
                }
                ))]);
                s = l
            } catch (e) {
        ...
        , ee = async () => {
            q || (q = (async () => {
                ...
                try {
                    ...
                    t.pv && (e.pv = JSON.stringify(t.pv)),
                    t.ba && (e.ba = t.ba),
                    t.usu && (e.usu = t.usu),
                    t.trial && (e.trial = t.trial),
                    t.its && (e.its = t.its),
                    1 == e.trial && t.msg ? e.msg = t.msg : b ? e.msg = b.message || b : t.msg && (e.msg = t.msg),
                    e.ar = t.in,
                    e.bafc = !!b
                } catch (e) {}
                A(e);
        ...
        , te = async () => {
            ...
            if (A(t),
            t && t < e)
                throw b ? new Error($.dlsErrorAndCacheExpire) : new Error($.checkLocalTime)
        }
        ;
        const re = new t;
        let ne = null
          , oe = async (e, t) => (R = R.then((async () => {
            try {
                let r = await w.keys();
                if (t || (re.isFulfilled ? e && (r = r.filter((t => t < e))) : e && r.includes(e) ? r = [e] : (r = [],
                A("Unexpected null key"))),
                !r.length)
                    return;
                for (let e = 0; e < r.length / 1e3; ++e) {
                    ...
                    {
                        let e = await _.getItem(S);
                        e && ([d] = JSON.parse(await L(e))),
                        _.setItem(S, await z(JSON.stringify([d, g])))
                    }
                    try {
                        ...
                        throw re.isFulfilled || re.resolve(),
                        e
                    }
                }
            } catch (e) {}
        ...
        return {
            i: async e => {
                ...
                f = e.fn,
                "string" == typeof f && (f = f.substring(0, 255)),
                e.ls && e.ls.length && (M = e.ls,
                1 == M.length && M.push(M[0])),
                m = !a || "200001" === a || a.startsWith("200001-"),
                h = e.sp,
                p = e.rmk,
                "string" == typeof p && (p = p.substring(0, 255)),
                e.cv && (y = "" + e.cv),
                C = e.updl,
                x = e.mnet,
                k = e.mxet,
                await X(),
                await (async () => {
                    I = E(String.fromCharCode(a.charCodeAt(0) + 10) + E(r) + E(a) + i + E("" + c)),
                    w = await v.createInstance({
                ...
                await Q(),
                await ee(),
                (!b || b.ltsErrorCode >= 102 && b.ltsErrorCode <= 120) && oe(null, !0)
            }
            ,
            i2: async ({updl: e, mxet: t, strDLC2: r}) => {
                C = e,
                k = t,
                await X(),
                U = e => D(String.fromCharCode.apply(null, e).replace(/\n/g, "+").replace(/\s/g, "="));
                ...
                let o = (new Date).kUtilFormat("yyyy-MM-ddTHH:mm:ss.SSSZ")
                  , i = await k();
                if (i && i < o)
                    throw new Error($.dlsOfflineLicenseExpired)
            }
            ,
            c: async () => {
                let e = new Date;
                ...
                try {
                    ...
                    e = t.startsWith("{") && t.endsWith("}") ? await (async e => {
                        if (n[U(B.c)] && n[U(B.c)][U(B.e)] && n[U(B.c)][U(B.e)][U(B.f)]) {
                            ...
                            return a.set(r),
                            a.set(i, r.length),
                            E(String.fromCharCode.apply(null, a))
                        }
                    }
                    )(t) : t,
                    e ? (A("bs " + r),
    ...
    const ie = {}
      , ae = async e => {
        let r = "string" == typeof e ? [e] : e
          , n = [];
        for (let e of r)
            n.push(ie[e] = ie[e] || new t);
        await Promise.all(n)
    }
      , se = async (e, r) => {
        let n, o = "string" == typeof e ? [e] : e, i = [];
        for (let e of o) {
            let o;
            i.push(o = ie[e] = ie[e] || new t(n = n || r())),
            o.isEmpty && (o.task = n = n || r())
        }
        await Promise.all(i)
    }
      , ce = [];
    q.setBufferIntoWasm = (e, t=0, r=0, n=0) => {
        ...
        return e.length > o.maxSize && (o.ptr && fe._free(o.ptr),
        o.ptr = fe._malloc(e.length),
        o.maxSize = e.length),
        fe.HEAPU8.set(e, o.ptr),
        o.size = e.length,
        o.ptr
    }
    ;
    const le = {
        ...
        prepare: function() {
            if (le.needed) {
                for (let e = 0; e < le.temps.length; e++)
                    fe._free(le.temps[e]);
                le.temps.length = 0,
                fe._free(le.buffer),
                le.buffer = 0,
            ...
            le.buffer || (le.size += 128,
            le.buffer = fe._malloc(le.size),
            assert(le.buffer)),
            le.pos = 0
        },
        alloc: function(e, t) {
            assert(le.buffer);
            let r, n = t.BYTES_PER_ELEMENT, o = e.length * n;
            return o = o + 7 & -8,
            le.pos + o >= le.size ? (assert(o > 0),
            le.needed += o,
            r = fe._malloc(o),
            le.temps.push(r)) : (r = le.buffer + le.pos,
            le.pos += o),
            r
        },
        copy: function(e, t, r) {
      ...
      , me = async e => {
        ...
        re = e.msg,
        de(),
        wasmImports.emscripten_bind_CoreWasm_static_init_1(ue(JSON.stringify(e)))
    }
      , he = () => {
    ...
    const ye = q.engineResourcePaths = {}
      , ge = q.loadCore = async () => {
        const e = "core";
        await se(e, (async () => {
            let t = Q && (Se(e + " loading..."),
            Date.now()) || 0
              , r = new Promise((r => {
                fe.onRuntimeInitialized = () => {
                    Q && Se(e + " initialized, cost " + (Date.now() - t) + " ms"),
                    r(void 0)
                }
            }
            ))
      ...
      , be = q.loadSideModule = async (e, {js: t, wasm: r}) => {
        await se(e, (async () => {
            await ae("core");
            let n = Q && (Se(e + " loading..."),
            Date.now()) || 0;
            ...
            wasmImports.emscripten_bind_CoreWasm_PreSetModuleExist && (de(),
            wasmImports.emscripten_bind_CoreWasm_PreSetModuleExist(ue(e.toUpperCase()))),
            wasmImports.emscripten_bind_CvrWasm_SetModuleExist && (de(),
            wasmImports.emscripten_bind_CvrWasm_SetModuleExist(ue(e.toUpperCase())));
      ...
      , ve = q.mapController = {
        loadWasm: async (e, t) => {
            try {
                Object.assign(ye, e.engineResourcePaths),
                e.needLoadCore && (e.bLog && (Q = !0),
                e.dm && (te = e.dm),
                e.bd && (oe = !0),
                await ge());
                for (let t of e.names)
                    await be(t, e.autoResources[t]);
                if (e.needLoadCore) {
        ...
        cfd: async (e, t) => {
            try {
                wasmImports.emscripten_bind_CoreWasm_static_CFD_1(e.count),
                we(t, {})
            } catch (e) {
                _e(t, e)
            }
    ...
    addEventListener("message", (e => {
        const t = e.data ? e.data : e
          ...
          , i = ve[t.type];
        if (!i)
            throw new Error("Unmatched task: " + t.type);
        i(r, n, o)
    }
    ));
