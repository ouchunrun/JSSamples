...
function locateFile(e) {
    ...
    n.open("GET", e, !0), n.responseType = "arraybuffer", n.onload = () => {
        200 == n.status || 0 == n.status && n.response ? r(n.response) : t(e)
...
assert(INITIAL_MEMORY >= 65536, "INITIAL_MEMORY should be larger than STACK_SIZE, was " + INITIAL_MEMORY + "! (STACK_SIZE=65536)"), wasmMemory = Module.wasmMemory ? Module.wasmMemory : new WebAssembly.Memory({
...
function initRuntime() {
    runtimeInitialized = !0, callRuntimeCallbacks(__RELOC_FUNCS__), Module.noFSInit || FS.init.initialized || FS.init(), FS.ignorePermissions = !1, TTY.init(), SOCKFS.root = FS.mount(SOCKFS, {}, null), callRuntimeCallbacks(__ATINIT__)
}
...
function instantiateArrayBuffer(e, r, t) {
    return getBinaryPromise(e).then((e => WebAssembly.instantiate(e, r))).then((e => e)).then(t, (e => {
        err(`failed to asynchronously prepare wasm: ${e}`), abort(e)
    }))
}

function instantiateAsync(e, r, t, n) {
    return e || "function" != typeof WebAssembly.instantiateStreaming || isDataURI(r) || "function" != typeof fetch ? instantiateArrayBuffer(r, t, n) : fetch(r, {
        credentials: "same-origin"
    }).then((e => WebAssembly.instantiateStreaming(e, t).then(n, (function (e) {
        return err(`wasm streaming compile failed: ${e}`), err("falling back to ArrayBuffer instantiation"), instantiateArrayBuffer(r, t, n)
    }))))
}
...
function createWasm() {
    ...
    function r(e, r) {
        ...
        var t = getDylinkMetadata(r);
        return t.neededDynlibs && (dynamicLibraries = t.neededDynlibs.concat(dynamicLibraries)), mergeLibSymbols(wasmExports, "main"), LDSO.init(), loadDylibs(), addOnInit(wasmExports.__wasm_call_ctors), __RELOC_FUNCS__.push(wasmExports.__wasm_apply_data_relocs), removeRunDependency("wasm-instantiate"), wasmExports
    }
...
wasmBinaryFile = "std.wasm", isDataURI(wasmBinaryFile) || (wasmBinaryFile = locateFile(wasmBinaryFile));
var ASM_CONSTS = {};
...
var GOT = {},
    ...
    getDylinkMetadata = e => {
        ...
        function o() {
            var t = n();
            return UTF8ArrayToString(e, (r += t) - t, t)
        }
        ...
        if (e instanceof WebAssembly.Module) {
            var i = WebAssembly.Module.customSections(e, s);
            0 === i.length && (s = "dylink", i = WebAssembly.Module.customSections(e, s)), a(0 === i.length, "need dylink section"), t = (e = new Uint8Array(i[0])).length
        } else {
            a(!(1836278016 == new Uint32Array(new Uint8Array(e.subarray(0, 24)).buffer)[0]), "need to see wasm magic number"), a(0 !== e[8], "need the dylink section to be first"), r = 9;
            var l = n();
            t = r + l, s = o()
        }
        var u = {
        ...
        if ("dylink" == s) {
            ...
            for (; r < t;) {
                var _ = e[r++],
                    p = n();
                if (1 === _) u.memorySize = n(), u.memoryAlign = n(), u.tableSize = n(), u.tableAlign = n();
                else if (2 === _)
                    for (c = n(), d = 0; d < c; ++d) m = o(), u.neededDynlibs.push(m);
                else if (3 === _)
                    for (var f = n(); f--;) {
                        var S = o();
                        256 & n() && u.tlsExports.add(S)
                    } else if (4 === _)
                        for (f = n(); f--;) {
                            o(), S = o();
                            1 == (3 & n()) && u.weakImports.add(S)
                        } else r += p
            }
        }
        return u
    ...
    newDSO = (e, r, t) => {
        ...
        return LDSO.loadedLibsByName[e] = n, null != r && (LDSO.loadedLibsByHandle[r] = n), n
    },
    LDSO = {
        loadedLibsByName: {},
        loadedLibsByHandle: {},
    ...
    convertJsFunctionToWasm = (e, r) => {
        if ("function" == typeof WebAssembly.Function) return new WebAssembly.Function(sigToWasmTypes(r), e);
        var t = [1];
        generateFuncType(r, t);
        var n = [0, 97, 115, 109, 1, 0, 0, 0, 1];
        uleb128Encode(t.length, n), n.push.apply(n, t), n.push(2, 7, 1, 1, 101, 1, 102, 0, 0, 7, 5, 1, 1, 102, 0, 0);
    ...
    functionsInTableMap, getFunctionAddress = e => (functionsInTableMap || (functionsInTableMap = new WeakMap, updateTableMap(0, wasmTable.length)), functionsInTableMap.get(e) || 0),
    freeTableIndexes = [],
    getEmptyTableSlot = () => {
    ...
    updateGOT = (e, r) => {
        for (var t in e)
            if (!isInternalSym(t)) {
                var n = e[t];
                t.startsWith("orig$") && (t = t.split("$")[1], r = !0), GOT[t] || (GOT[t] = new WebAssembly.Global({
                    value: "i32",
                    mutable: !0
                })), (r || 0 == GOT[t].value) && ("function" == typeof n ? GOT[t].value = addFunction(n) : "number" == typeof n ? GOT[t].value = n : err(`unhandled export type for '${t}': ${typeof n}`))
            }
    },
    relocateExports = (e, r, t) => {
        ...
        for (var o in e) {
            var a = e[o];
            "object" == typeof a && (a = a.value), "number" == typeof a && (a += r), n[o] = a
        }
    ...
    dynCall = (e, r, t) => e.includes("j") ? dynCallLegacy(e, r, t) : getWasmTableEntry(r).apply(null, t),
    ...
    resolveGlobalSymbol = (e, r = !1) => {
        var t;
        return r && "orig$" + e in wasmImports && (e = "orig$" + e), isSymbolDefined(e) ? t = wasmImports[e] : e.startsWith("invoke_") && (t = wasmImports[e] = createInvokeFunction(e.split("_")[1])), {
            sym: t,
            name: e
        }
    },
    UTF8ToString = (e, r) => e ? UTF8ArrayToString(HEAPU8, e, r) : "",
    loadWebAssemblyModule = (e, r, t, n, o) => {
        var a = getDylinkMetadata(e);

        function s() {
            var t = !o || !HEAP8[o + 8 | 0];
            if (t) {
                var s = Math.pow(2, a.memoryAlign),
                    i = a.memorySize ? alignMemory(getMemory(a.memorySize + s), s) : 0,
                    l = a.tableSize ? wasmTable.length : 0;
                o && (HEAP8[o + 8 | 0] = 1, HEAPU32[o + 12 >> 2] = i, HEAP32[o + 16 >> 2] = a.memorySize, HEAPU32[o + 20 >> 2] = l, HEAP32[o + 24 >> 2] = a.tableSize)
            } else i = HEAPU32[o + 12 >> 2], l = HEAPU32[o + 20 >> 2];
            var u = l + a.tableSize - wasmTable.length,
                c;

            function d(e) {
                var r = resolveGlobalSymbol(e).sym;
                return !r && n && (r = n[e]), r || (r = c[e]), r
            }
            u > 0 && wasmTable.grow(u);
            var m = {
                    get(e, r) {
                        switch (r) {
                            case "__memory_base":
                        ...
                        var t;
                        r in e || (e[r] = function () {
                            return t || (t = d(r)), t.apply(null, arguments)
                        });
                        return e[r]
                    }
                },
            ...
            function f(e, t) {
                function n(e, r) {
                    for (var t = [], n = 0; n < 16 && -1 != r.indexOf("$" + n); n++) t.push("$" + n);
                    t = t.join(",");
                    var a = `(${t}) => { ${r} };`;
                    ASM_CONSTS[o] = eval(a)
                }
                if (updateTableMap(l, a.tableSize), c = relocateExports(t.exports, i), r.allowUndefined || reportUndefinedSymbols(), "__start_em_asm" in c)
                    for (var o = c.__start_em_asm, s = c.__stop_em_asm; o < s;) {
                        var u = UTF8ToString(o);
                        n(o, u), o = HEAPU8.indexOf(0, o) + 1
                    }

                function d(e, r, t) {
                    var n = [];
                    if (r = r.slice(1, -1), "void" != r)
                        for (var o in r = r.split(","), r) {
                            var a = r[o].split(" ").pop();
                            n.push(a.replace("*", ""))
                        }
                    var s = `(${n}) => ${t};`;
                ...
                for (var m in c)
                    if (m.startsWith("__em_js__")) {
                        var o = c[m],
                            u = UTF8ToString(o),
                            _ = u.split("<::>");
                        d(m.replace("__em_js__", ""), _[0], _[1]), delete c[m]
                    } var p = c.__wasm_apply_data_relocs;
                p && (runtimeInitialized ? p() : __RELOC_FUNCS__.push(p));
                var f = c.__wasm_call_ctors;
                return f && (runtimeInitialized ? f() : __ATINIT__.push(f)), c
            }
            if (r.loadAsync) {
                if (e instanceof WebAssembly.Module) {
                    var S = new WebAssembly.Instance(e, p);
                    return Promise.resolve(f(e, S))
                }
                return WebAssembly.instantiate(e, p).then((e => f(e.module, e.instance)))
            }
            var h = e instanceof WebAssembly.Module ? e : new WebAssembly.Module(e),
                S = new WebAssembly.Instance(h, p);
            return f(h, S)
        }
        return currentModuleWeakSymbols = a.weakImports, r.loadAsync ? a.neededDynlibs.reduce(((e, t) => e.then((() => loadDynamicLibrary(t, r)))), Promise.resolve()).then(s) : (a.neededDynlibs.forEach((e => loadDynamicLibrary(e, r, n))), s())
    },
    mergeLibSymbols = (e, r) => {
        for (var t in e) {
            if (!e.hasOwnProperty(t)) continue;
            const r = r => {
                isSymbolDefined(r) || (wasmImports[r] = e[t])
            };
            r(t);
            const n = "__main_argc_argv";
            "main" == t && r(n), t == n && r("main"), t.startsWith("dynCall_") && !Module.hasOwnProperty(t) && (Module[t] = e[t])
        }
    },
    asyncLoad = (e, r, t, n) => {
        ...
        var e = {
            ...
            handle: (r, t, n, o) => {
                e.promiseChainEnd = e.promiseChainEnd.then((() => loadWebAssemblyModule(r, {
                    ...
                    preloadedWasm[t] = e, n(r)
                }), (e => {
                    err(`failed to instantiate wasm: ${t}: ${e}`), o()
                }))
            }
        };
...
function loadDynamicLibrary(e, r = {
    ...
    if (o) return r.global ? o.global || (o.global = !0, mergeLibSymbols(o.exports, e)) : t && Object.assign(t, o.exports), r.nodelete && o.refcount !== 1 / 0 && (o.refcount = 1 / 0), o.refcount++, n && (LDSO.loadedLibsByHandle[n] = o), !r.loadAsync || Promise.resolve(!0);

    function a() {
        if (n) {
            var t = HEAPU32[n + 28 >> 2],
                o = HEAPU32[n + 32 >> 2];
            if (t && o) {
                var a = HEAP8.slice(t, t + o);
                return r.loadAsync ? Promise.resolve(a) : a
            }
        }
        var s = locateFile(e);
        if (r.loadAsync) return new Promise((function (e, r) {
            asyncLoad(s, (r => e(r)), r)
        }));
        if (!readBinary) throw new Error(`${s}: file not found, and synchronous loading of external files is not available`);
        return readBinary(s)
    }

    function s() {
        var o = preloadedWasm[e];
        return o ? r.loadAsync ? Promise.resolve(o) : o : r.loadAsync ? a().then((o => loadWebAssemblyModule(o, r, e, t, n))) : loadWebAssemblyModule(a(), r, e, t, n)
    }

    function i(r) {
        o.global ? mergeLibSymbols(r, e) : t && Object.assign(t, r), o.exports = r
    }
    return (o = newDSO(e, n, "loading")).refcount = r.nodelete ? 1 / 0 : 1, o.global = r.global, r.loadAsync ? s().then((e => (i(e), !0))) : (i(s()), !0)
}
var reportUndefinedSymbols = () => {
    for (var e in GOT)
        if (0 == GOT[e].value) {
            var r = resolveGlobalSymbol(e, !0).sym;
            if (!r && !GOT[e].required) continue;
            if ("function" == typeof r) GOT[e].value = addFunction(r, r.sig);
            else {
...
async function loadDylibs() {
    return await new Promise(((e, r) => {
        dynamicLibraries.length && (addRunDependency("loadDylibs"), dynamicLibraries.slice(0, 1).reduce((function (e, r) {
            ...
            removeRunDependency("loadDylibs"), e()
        })))
    }))
}
...
var exceptionLast = 0,
    ...
    ___cxa_throw = (e, r, t) => {
        throw new ExceptionInfo(e).init(r, t), uncaughtExceptionCount++, exceptionLast = e
    };
...
var ___memory_base = new WebAssembly.Global({
    ...
    PATH = {
        ...
        normalize: e => {
            var r = PATH.isAbs(e),
                t = "/" === e.substr(-1);
            return (e = PATH.normalizeArray(e.split("/").filter((e => !!e)), !r).join("/")) || r || (e = "."), e && t && (e += "/"), (r ? "/" : "") + e
        },
        dirname: e => {
    ...
    PATH_FS = {
        resolve: function () {
            ...
            return (r ? "/" : "") + (e = PATH.normalizeArray(e.split("/").filter((e => !!e)), !r).join("/")) || "."
        },
        relative: (e, r) => {
            function t(e) {
            ...
            for (var n = t(e.split("/")), o = t(r.split("/")), a = Math.min(n.length, o.length), s = a, i = 0; i < a; i++)
                if (n[i] !== o[i]) {
                    s = i;
                    break
                } var l = [];
    ...
    stringToUTF8Array = (e, r, t, n) => {
        ...
        for (var o = t, a = t + n - 1, s = 0; s < e.length; ++s) {
            ...
            if (i >= 55296 && i <= 57343) i = 65536 + ((1023 & i) << 10) | 1023 & e.charCodeAt(++s);
            if (i <= 127) {
                if (t >= a) break;
                r[t++] = i
            } else if (i <= 2047) {
...
var FS_stdin_getChar = () => {
        ...
        stream_ops: {
            ...
            write(e, r, t, n, o, a) {
                ...
                if (MEMFS.expandFileStorage(s, o + n), s.contents.subarray && r.subarray) s.contents.set(r.subarray(t, t + n), o);
                    ...
                    for (var i = 0; i < n; i++) s.contents[o + i] = r[t + i];
            ...
            mmap(e, r, t, n, o) {
                ...
                if (2 & o || i.buffer !== HEAP8.buffer) {
                    if ((t > 0 || t + r < i.length) && (i = i.subarray ? i.subarray(t, t + r) : Array.prototype.slice.call(i, t, t + r)), s = !0, !(a = mmapAlloc(r))) throw new FS.ErrnoError(48);
                    HEAP8.set(i, a)
            ...
            msync: (e, r, t, n, o) => (MEMFS.stream_ops.write(e, r, 0, n, t, !1), 0)
        }
    },
    FS_createDataFile = (e, r, t, n, o, a) => FS.createDataFile(e, r, t, n, o, a),
    ...
    FS_createPreloadedFile = (e, r, t, n, o, a, s, i, l, u) => {
        var c = r ? PATH_FS.resolve(PATH.join2(e, r)) : e,
            d = getUniqueRunDependency(`cp ${c}`);

        function m(t) {
            function m(t) {
                u && u(), i || FS_createDataFile(e, r, t, n, o, l), a && a(), removeRunDependency(d)
            }
            FS_handledByPreloadPlugin(t, c, m, (() => {
                s && s(), removeRunDependency(d)
            })) || m(t)
        }
        addRunDependency(d), "string" == typeof t ? asyncLoad(t, (e => m(e)), s) : m(t)
    },
    ...
    FS = {
        ...
        lookupPath(e, r = {}) {
            ...
            if ((r = Object.assign({
                    follow_mount: !0,
                    recurse_count: 0
                }, r)).recurse_count > 8) throw new FS.ErrnoError(32);
            for (var t = e.split("/").filter((e => !!e)), n = FS.root, o = "/", a = 0; a < t.length; a++) {
                var s = a === t.length - 1;
                if (s && r.parent) break;
                if (n = FS.lookupNode(n, t[a]), o = PATH.join2(o, t[a]), FS.isMountpoint(n) && (!s || s && r.follow_mount) && (n = n.mounted.root), !s || r.follow)
                    for (var i = 0; FS.isLink(n.mode);) {
                        var l = FS.readlink(o);
                        if (o = PATH_FS.resolve(PATH.dirname(o), l), n = FS.lookupPath(o, {
        ...
        nodePermissions: (e, r) => FS.ignorePermissions || (!r.includes("r") || 292 & e.mode) && (!r.includes("w") || 146 & e.mode) && (!r.includes("x") || 73 & e.mode) ? 0 : 2,
        mayLookup(e) {
        ...
        mayOpen: (e, r) => e ? FS.isLink(e.mode) ? 32 : FS.isDir(e.mode) && ("r" !== FS.flagsToPermissionString(r) || 512 & r) ? 31 : FS.nodePermissions(e, FS.flagsToPermissionString(r)) : 44,
        MAX_OPEN_FDS: 4096,
        nextfd() {
        ...
        createStream: (e, r = -1) => (FS.FSStream || (FS.FSStream = function () {
            this.shared = {}
        ...
        })), e = Object.assign(new FS.FSStream, e), -1 == r && (r = FS.nextfd()), e.fd = r, FS.streams[r] = e, e),
        closeStream(e) {
            FS.streams[e] = null
        },
        chrdev_stream_ops: {
        ...
        mount(e, r, t) {
            ...
            if (!o && !a) {
                var s = FS.lookupPath(t, {
                    follow_mount: !1
                });
                if (t = s.path, n = s.node, FS.isMountpoint(n)) throw new FS.ErrnoError(10);
            ...
            var i = {
                ...
                l = e.mount(i);
            return l.mount = i, i.root = l, o ? FS.root = l : n && (n.mounted = i, n.mount && n.mount.mounts.push(i)), l
        },
        unmount(e) {
        ...
        create: (e, r) => (r = void 0 !== r ? r : 438, r &= 4095, r |= 32768, FS.mknod(e, r, 0)),
        mkdir: (e, r) => (r = void 0 !== r ? r : 511, r &= 1023, r |= 16384, FS.mknod(e, r, 0)),
        mkdirTree(e, r) {
        ...
        mkdev: (e, r, t) => (void 0 === t && (t = r, r = 438), r |= 8192, FS.mknod(e, r, t)),
        symlink(e, r) {
        ...
        rename(e, r) {
            ...
            if (t = FS.lookupPath(e, {
                    ...
                    parent: !0
                }).node, !t || !n) throw new FS.ErrnoError(44);
            if (t.mount !== n.mount) throw new FS.ErrnoError(75);
            var l, u = FS.lookupNode(t, s),
            ...
            if (u !== l) {
                var d = FS.isDir(u.mode),
                    m = FS.mayDelete(t, s, d);
                if (m) throw new FS.ErrnoError(m);
                if (m = l ? FS.mayDelete(n, i, d) : FS.mayCreate(n, i)) throw new FS.ErrnoError(m);
                if (!t.node_ops.rename) throw new FS.ErrnoError(63);
                if (FS.isMountpoint(u) || l && FS.isMountpoint(l)) throw new FS.ErrnoError(10);
                if (n !== t && (m = FS.nodePermissions(t, "w"))) throw new FS.ErrnoError(m);
                FS.hashRemoveNode(u);
                try {
                    t.node_ops.rename(u, n, i)
                } catch (e) {
                    throw e
                } finally {
                    FS.hashAddNode(u)
        ...
        open(e, r, t) {
            ...
            var n;
            if (t = void 0 === t ? 438 : t, t = 64 & (r = "string" == typeof r ? FS_modeStringToFlags(r) : r) ? 4095 & t | 32768 : 0, "object" == typeof e) n = e;
            else {
                e = PATH.normalize(e);
                try {
                    n = FS.lookupPath(e, {
            ...
            if (FS.isChrdev(n.mode) && (r &= -513), 65536 & r && !FS.isDir(n.mode)) throw new FS.ErrnoError(54);
            if (!o) {
            ...
            return s.stream_ops.open && s.stream_ops.open(s), !Module.logReadFiles || 1 & r || (FS.readFiles || (FS.readFiles = {}), e in FS.readFiles || (FS.readFiles[e] = 1)), s
        },
        close(e) {
        ...
        mmap(e, r, t, n, o) {
            if (2 & n && !(2 & o) && 2 != (2097155 & e.flags)) throw new FS.ErrnoError(2);
        ...
        createDataFile(e, r, t, n, o, a) {
            var s = r;
            e && (e = "string" == typeof e ? e : FS.getPath(e), s = r ? PATH.join2(e, r) : e);
            var i = FS_getMode(n, o),
                l = FS.create(s, i);
            if (t) {
                if ("string" == typeof t) {
                ...
                FS.chmod(l, 146 | i);
                var m = FS.open(l, 577);
                FS.write(m, t, 0, t.length, 0, a), FS.close(m), FS.chmod(l, i)
            }
            return l
        },
            ...
            return FS.registerDevice(s, {
                ...
                read(e, r, n, o, a) {
                    for (var s = 0, i = 0; i < o; i++) {
                        ...
                        if (void 0 === l && 0 === s) throw new FS.ErrnoError(6);
                        if (null == l) break;
                        s++, r[n + i] = l
                    }
        ...
        createLazyFile(e, r, t, n, o) {
            ...
            if (a.prototype.get = function (e) {
                    ...
                    i.setDataGetter((e => {
                        ...
                        return i.chunks[e]
                    })), !a && n || (s = n = 1, n = this.getter(0).length, s = n, out("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = n, this._chunkSize = s, this.lengthKnown = !0
            ...
            var l = FS.createFile(e, r, i, n, o);
            i.contents ? l.contents = i.contents : i.url && (l.contents = null, l.url = i.url), Object.defineProperties(l, {
                usedBytes: {
                    get: function () {
            ...
            })), u.read = (e, r, t, n, o) => (FS.forceLoadFile(l), c(e, r, t, n, o)), u.mmap = (e, r, t, n, o) => {
                FS.forceLoadFile(l);
                var a = mmapAlloc(r);
                if (!a) throw new FS.ErrnoError(48);
                return c(e, HEAP8, a, r, t), {
                    ptr: a,
                    allocated: !0
                }
            }, l.stream_ops = u, l
    ...
    SYSCALLS = {
        ...
        calculateAt(e, r, t) {
            ...
            var n; - 100 === e ? n = FS.cwd() : n = SYSCALLS.getStreamFromFD(e).path;
            if (0 == r.length) {
                if (!t) throw new FS.ErrnoError(44);
                return n
            }
        ...
        doStat(e, r, t) {
            ...
            HEAP32[t >> 2] = n.dev, HEAP32[t + 4 >> 2] = n.mode, HEAPU32[t + 8 >> 2] = n.nlink, HEAP32[t + 12 >> 2] = n.uid, HEAP32[t + 16 >> 2] = n.gid, HEAP32[t + 20 >> 2] = n.rdev, tempI64 = [n.size >>> 0, (tempDouble = n.size, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[t + 24 >> 2] = tempI64[0], HEAP32[t + 28 >> 2] = tempI64[1], HEAP32[t + 32 >> 2] = 4096, HEAP32[t + 36 >> 2] = n.blocks;
            var o = n.atime.getTime(),
                a = n.mtime.getTime(),
                s = n.ctime.getTime();
            return tempI64 = [Math.floor(o / 1e3) >>> 0, (tempDouble = Math.floor(o / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[t + 40 >> 2] = tempI64[0], HEAP32[t + 44 >> 2] = tempI64[1], HEAPU32[t + 48 >> 2] = o % 1e3 * 1e3, tempI64 = [Math.floor(a / 1e3) >>> 0, (tempDouble = Math.floor(a / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[t + 56 >> 2] = tempI64[0], HEAP32[t + 60 >> 2] = tempI64[1], HEAPU32[t + 64 >> 2] = a % 1e3 * 1e3, tempI64 = [Math.floor(s / 1e3) >>> 0, (tempDouble = Math.floor(s / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[t + 72 >> 2] = tempI64[0], HEAP32[t + 76 >> 2] = tempI64[1], HEAPU32[t + 80 >> 2] = s % 1e3 * 1e3, tempI64 = [n.ino >>> 0, (tempDouble = n.ino, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[t + 88 >> 2] = tempI64[0], HEAP32[t + 92 >> 2] = tempI64[1], 0
        },
        doMsync(e, r, t, n, o) {
...
function ___syscall__newselect(e, r, t, n, o) {
    try {
        for (var a = 0, s = r ? HEAP32[r >> 2] : 0, i = r ? HEAP32[r + 4 >> 2] : 0, l = t ? HEAP32[t >> 2] : 0, u = t ? HEAP32[t + 4 >> 2] : 0, c = n ? HEAP32[n >> 2] : 0, d = n ? HEAP32[n + 4 >> 2] : 0, m = 0, _ = 0, p = 0, f = 0, S = 0, h = 0, y = (r ? HEAP32[r >> 2] : 0) | (t ? HEAP32[t >> 2] : 0) | (n ? HEAP32[n >> 2] : 0), g = (r ? HEAP32[r + 4 >> 2] : 0) | (t ? HEAP32[t + 4 >> 2] : 0) | (n ? HEAP32[n + 4 >> 2] : 0), E = function (e, r, t, n) {
                return e < 32 ? r & n : t & n
            }, F = 0; F < e; F++) {
            var w = 1 << F % 32;
            if (E(F, y, g, w)) {
                var v = SYSCALLS.getStreamFromFD(F),
                    b = SYSCALLS.DEFAULT_POLLMASK;
                if (v.stream_ops.poll) {
                    var A = -1;
                    if (o) A = 1e3 * ((r ? HEAP32[o >> 2] : 0) + (r ? HEAP32[o + 8 >> 2] : 0) / 1e6);
                    b = v.stream_ops.poll(v, A)
                }
                1 & b && E(F, s, i, w) && (F < 32 ? m |= w : _ |= w, a++), 4 & b && E(F, l, u, w) && (F < 32 ? p |= w : f |= w, a++), 2 & b && E(F, c, d, w) && (F < 32 ? S |= w : h |= w, a++)
            }
        }
        return r && (HEAP32[r >> 2] = m, HEAP32[r + 4 >> 2] = _), t && (HEAP32[t >> 2] = p, HEAP32[t + 4 >> 2] = f), n && (HEAP32[n >> 2] = S, HEAP32[n + 4 >> 2] = h), a
    } catch (e) {
...
___syscall__newselect.sig = "iipppp", ___syscall_chmod.sig = "ipi";
var SOCKFS = {
        mount: e => (Module.websocket = Module.websocket && "object" == typeof Module.websocket ? Module.websocket : {}, Module.websocket._callbacks = {}, Module.websocket.on = function (e, r) {
        ...
        createSocket(e, r, t) {
            if (1 == (r &= -526337) && t && 6 != t) throw new FS.ErrnoError(66);
            var n = {
                    family: e,
                    type: r,
                    protocol: t,
        ...
        nextname: () => (SOCKFS.nextname.current || (SOCKFS.nextname.current = 0), "socket[" + SOCKFS.nextname.current++ + "]"),
        websocket_sock_ops: {
            createPeer(e, r, t) {
                var n;
                if ("object" == typeof r && (n = r, r = null, t = null), n)
                    ...
                    var a = Module.websocket && "object" == typeof Module.websocket,
                        s = "ws:#".replace("#", "//");
                    if (a && "string" == typeof Module.websocket.url && (s = Module.websocket.url), "ws://" === s || "wss://" === s) {
                        var i = r.split("/");
                        s = s + i[0] + ":" + t + "/" + i.slice(1).join("/")
                    }
                    var l = "binary";
                    a && "string" == typeof Module.websocket.subprotocol && (l = Module.websocket.subprotocol);
                    var u = void 0;
                    "null" !== l && (u = l = l.replace(/^ +| +$/g, "").split(/ *, */)), a && null === Module.websocket.subprotocol && (l = "null", u = void 0), (n = new WebSocket(s, u)).binaryType = "arraybuffer"
                } catch (e) {
                ...
                return SOCKFS.websocket_sock_ops.addPeer(e, c), SOCKFS.websocket_sock_ops.handlePeerEvents(e, c), 2 === e.type && void 0 !== e.sport && c.dgram_send_queue.push(new Uint8Array([255, 255, 255, 255, "p".charCodeAt(0), "o".charCodeAt(0), "r".charCodeAt(0), "t".charCodeAt(0), (65280 & e.sport) >> 8, 255 & e.sport])), c
            },
            getPeer: (e, r, t) => e.peers[r + ":" + t],
            addPeer(e, r) {
            ...
            handlePeerEvents(e, r) {
                var t = !0,
                    n = function () {
                        ...
                        try {
                            for (var t = r.dgram_send_queue.shift(); t;) r.socket.send(t), t = r.dgram_send_queue.shift()
                        } catch (e) {
                            r.socket.close()
                        }
                    };
                ...
                function o(n) {
                    if ("string" == typeof n) {
                        ...
                        if (assert(void 0 !== n.byteLength), 0 == n.byteLength) return;
                        n = new Uint8Array(n)
                    }
                    var o = t;
                    if (t = !1, o && 10 === n.length && 255 === n[0] && 255 === n[1] && 255 === n[2] && 255 === n[3] && n[4] === "p".charCodeAt(0) && n[5] === "o".charCodeAt(0) && n[6] === "r".charCodeAt(0) && n[7] === "t".charCodeAt(0)) {
                        var a = n[8] << 8 | n[9];
                        return SOCKFS.websocket_sock_ops.removePeer(e, r), r.port = a, void SOCKFS.websocket_sock_ops.addPeer(e, r)
                    }
                    e.recv_queue.push({
                        addr: r.addr,
                        port: r.port,
                ...
                ENVIRONMENT_IS_NODE ? (r.socket.on("open", n), r.socket.on("message", (function (e, r) {
            ...
            bind(e, r, t) {
                if (void 0 !== e.saddr || void 0 !== e.sport) throw new FS.ErrnoError(28);
            ...
            getname(e, r) {
                var t, n;
                if (r) {
                    if (void 0 === e.daddr || void 0 === e.dport) throw new FS.ErrnoError(53);
                    t = e.daddr, n = e.dport
            ...
            sendmsg(e, r, t, n, o, a) {
                if (2 === e.type) {
                    if (void 0 !== o && void 0 !== a || (o = e.daddr, a = e.dport), void 0 === o || void 0 === a) throw new FS.ErrnoError(17)
                } else o = e.daddr, a = e.dport;
                var s, i = SOCKFS.websocket_sock_ops.getPeer(e, o, a);
                if (1 === e.type) {
                    if (!i || i.socket.readyState === i.socket.CLOSING || i.socket.readyState === i.socket.CLOSED) throw new FS.ErrnoError(53);
                    if (i.socket.readyState === i.socket.CONNECTING) throw new FS.ErrnoError(6)
                }
                if (ArrayBuffer.isView(r) && (t += r.byteOffset, r = r.buffer), s = r.slice(t, t + n), 2 === e.type && (!i || i.socket.readyState !== i.socket.OPEN)) return i && i.socket.readyState !== i.socket.CLOSING && i.socket.readyState !== i.socket.CLOSED || (i = SOCKFS.websocket_sock_ops.createPeer(e, o, a)), i.dgram_send_queue.push(s), n;
                try {
                    return i.socket.send(s), n
                } catch (e) {
            ...
            recvmsg(e, r) {
                ...
                var o = t.data.byteLength || t.data.length,
                    ...
                    s = t.data.buffer || t.data,
                    i = Math.min(r, o),
                    l = {
                        buffer: new Uint8Array(s, a, i),
                        addr: t.addr,
                        port: t.port
                    };
                if (1 === e.type && i < o) {
                    var u = o - i;
                    t.data = new Uint8Array(s, a + i, u), e.recv_queue.unshift(t)
                }
                return l
            }
        }
    ...
    setErrNo = e => (HEAP32[___errno_location() >> 2] = e, e),
    inetNtop4 = e => (255 & e) + "." + (e >> 8 & 255) + "." + (e >> 16 & 255) + "." + (e >> 24 & 255),
    inetNtop6 = e => {
        var r = "",
            t = 0,
            n = 0,
        ...
        for (i = 0; i < 5; i++)
            ...
            if (c = inetNtop4(l[6] | l[7] << 16), -1 === l[5]) return r = "::ffff:", r += c;
            if (0 === l[5]) return r = "::", "0.0.0.0" === c && (c = ""), "0.0.0.1" === c && (c = "1"), r += c
        }
        for (t = 0; t < 8; t++) 0 === l[t] && (t - o > 1 && (s = 0), o = t, s++), s > n && (a = t - (n = s) + 1);
        for (t = 0; t < 8; t++) n > 1 && 0 === l[t] && t >= a && t < a + n ? t === a && (r += ":", 0 === a && (r += ":")) : (r += Number(_ntohs(65535 & l[t])).toString(16), r += t < 7 ? ":" : "");
        return r
    },
    readSockaddr = (e, r) => {
        var t, n = HEAP16[e >> 1],
        ...
        switch (n) {
            case 2:
                ...
                t = HEAP32[e + 4 >> 2], t = inetNtop4(t);
                break;
            case 10:
                if (28 !== r) return {
                    errno: 28
                };
                t = [HEAP32[e + 8 >> 2], HEAP32[e + 12 >> 2], HEAP32[e + 16 >> 2], HEAP32[e + 20 >> 2]], t = inetNtop6(t);
                break;
            default:
                return {
                    errno: 5
    ...
    inetPton6 = e => {
        ...
        for ((e = e.startsWith("::") ? e.replace("::", "Z:") : e.replace("::", ":Z:")).indexOf(".") > 0 ? ((r = (e = e.replace(new RegExp("[.]", "g"), ":")).split(":"))[r.length - 4] = jstoi_q(r[r.length - 4]) + 256 * jstoi_q(r[r.length - 3]), r[r.length - 3] = jstoi_q(r[r.length - 2]) + 256 * jstoi_q(r[r.length - 1]), r = r.slice(0, r.length - 2)) : r = e.split(":"), n = 0, o = 0, t = 0; t < r.length; t++)
    ...
    DNS = {
        ...
        lookup_name(e) {
            ...
            if (DNS.address_map.addrs[e]) r = DNS.address_map.addrs[e];
                ...
                assert(n < 65535, "exceeded max address mappings of 65535"), r = "172.29." + (255 & n) + "." + (65280 & n), DNS.address_map.names[r] = e, DNS.address_map.addrs[e] = r
            }
            return r
        },
        lookup_addr: e => DNS.address_map.names[e] ? DNS.address_map.names[e] : null
    },
    getSocketAddress = (e, r, t) => {
...
function ___syscall_connect(e, r, t, n, o, a) {
    try {
        var s = getSocketFromFD(e),
            i = getSocketAddress(r, t);
        return s.sock_ops.connect(s, i.addr, i.port), 0
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name) throw e;
        return -e.errno
    }
...
___syscall_connect.sig = "iippiii", ___syscall_fchmod.sig = "iii", ___syscall_fcntl64.sig = "iiip", ___syscall_fstat64.sig = "iip";
var convertI32PairToI53Checked = (e, r) => r + 2097152 >>> 0 < 4194305 - !!e ? (e >>> 0) + 4294967296 * r : NaN;
...
function ___syscall_getdents64(e, r, t) {
    try {
        ...
        for (var o = 280, a = 0, s = FS.llseek(n, 0, 1), i = Math.floor(s / o); i < n.getdents.length && a + o <= t;) {
            var l, u, c = n.getdents[i];
            if ("." === c) l = n.node.id, u = 4;
            else if (".." === c) {
                l = FS.lookupPath(n.path, {
                    parent: !0
                }).node.id, u = 4
            } else {
                var d = FS.lookupNode(n.node, c);
                l = d.id, u = FS.isChrdev(d.mode) ? 2 : FS.isDir(d.mode) ? 4 : FS.isLink(d.mode) ? 10 : 8
            }
            tempI64 = [l >>> 0, (tempDouble = l, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + a >> 2] = tempI64[0], HEAP32[r + a + 4 >> 2] = tempI64[1], tempI64 = [(i + 1) * o >>> 0, (tempDouble = (i + 1) * o, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + a + 8 >> 2] = tempI64[0], HEAP32[r + a + 12 >> 2] = tempI64[1], HEAP16[r + a + 16 >> 1] = 280, HEAP8[r + a + 18 | 0] = u, stringToUTF8(c, r + a + 19, 256), a += o, i += 1
        }
        return FS.llseek(n, i * o, 0), a
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name) throw e;
        return -e.errno
    }
        ...
        switch (r) {
            ...
            case 21505:
                ...
                if (n.tty.ops.ioctl_tcgets) {
                    ...
                    for (var s = 0; s < 32; s++) HEAP8[a + s + 17 | 0] = o.c_cc[s] || 0;
                    return 0
                }
                return 0;
            case 21506:
            ...
            case 21508:
                ...
                if (n.tty.ops.ioctl_tcsets) {
                    ...
                    var i = HEAP32[a >> 2],
                        ...
                        c = HEAP32[a + 12 >> 2],
                        d = [];
                    for (s = 0; s < 32; s++) d.push(HEAP8[a + s + 17 | 0]);
...
function ___syscall_mkdirat(e, r, t) {
    try {
        return r = SYSCALLS.getStr(r), r = SYSCALLS.calculateAt(e, r), "/" === (r = PATH.normalize(r))[r.length - 1] && (r = r.substr(0, r.length - 1)), FS.mkdir(r, t, 0), 0
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name) throw e;
        return -e.errno
    }
...
function ___syscall_newfstatat(e, r, t, n) {
    try {
        ...
        var o = 256 & n,
            a = 4096 & n;
        return n &= -6401, r = SYSCALLS.calculateAt(e, r, a), SYSCALLS.doStat(o ? FS.lstat : FS.stat, r, t)
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name) throw e;
        return -e.errno
    }
...
function ___syscall_symlink(e, r) {
    try {
        return e = SYSCALLS.getStr(e), r = SYSCALLS.getStr(r), FS.symlink(e, r), 0
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name) throw e;
        return -e.errno
    }
}
___syscall_getdents64.sig = "iipp", ___syscall_ioctl.sig = "iiip", ___syscall_lstat64.sig = "ipp", ___syscall_mkdirat.sig = "iipi", ___syscall_newfstatat.sig = "iippi", ___syscall_openat.sig = "iipip", ___syscall_readlinkat.sig = "iippp", ___syscall_socket.sig = "iiiiiii", ___syscall_stat64.sig = "ipp", ___syscall_symlink.sig = "ipp";
...
function __gmtime_js(e, r, t) {
    var n = convertI32PairToI53Checked(e, r),
        o = new Date(1e3 * n);
    HEAP32[t >> 2] = o.getUTCSeconds(), HEAP32[t + 4 >> 2] = o.getUTCMinutes(), HEAP32[t + 8 >> 2] = o.getUTCHours(), HEAP32[t + 12 >> 2] = o.getUTCDate(), HEAP32[t + 16 >> 2] = o.getUTCMonth(), HEAP32[t + 20 >> 2] = o.getUTCFullYear() - 1900, HEAP32[t + 24 >> 2] = o.getUTCDay();
    var a = Date.UTC(o.getUTCFullYear(), 0, 1, 0, 0, 0, 0),
        s = (o.getTime() - a) / 864e5 | 0;
    HEAP32[t + 28 >> 2] = s
}
__emscripten_get_now_is_monotonic.sig = "i", __gmtime_js.sig = "viip";
...
function __localtime_js(e, r, t) {
    var n = convertI32PairToI53Checked(e, r),
        o = new Date(1e3 * n);
    HEAP32[t >> 2] = o.getSeconds(), HEAP32[t + 4 >> 2] = o.getMinutes(), HEAP32[t + 8 >> 2] = o.getHours(), HEAP32[t + 12 >> 2] = o.getDate(), HEAP32[t + 16 >> 2] = o.getMonth(), HEAP32[t + 20 >> 2] = o.getFullYear() - 1900, HEAP32[t + 24 >> 2] = o.getDay();
    var a = 0 | ydayFromDate(o);
    HEAP32[t + 28 >> 2] = a, HEAP32[t + 36 >> 2] = -60 * o.getTimezoneOffset();
    var s = new Date(o.getFullYear(), 0, 1),
        i = new Date(o.getFullYear(), 6, 1).getTimezoneOffset(),
        l = s.getTimezoneOffset(),
        u = 0 | (i != l && o.getTimezoneOffset() == Math.min(l, i));
    HEAP32[t + 32 >> 2] = u
}
...
var stringToNewUTF8 = e => {
    ...
    __tzset_js = (e, r, t) => {
        ...
        HEAPU32[e >> 2] = 60 * l, HEAP32[r >> 2] = Number(s != i);
        var c = u(o),
            d = u(a),
            m = stringToNewUTF8(c),
            _ = stringToNewUTF8(d);
        i < s ? (HEAPU32[t >> 2] = m, HEAPU32[t + 4 >> 2] = _) : (HEAPU32[t >> 2] = _, HEAPU32[t + 4 >> 2] = m)
    };
__tzset_js.sig = "vppp";
var _abort = () => {
    abort("")
...
var getHeapMax = () => 2147483648,
    ...
    _emscripten_get_now;
_emscripten_get_heap_max.sig = "p", _emscripten_get_now = () => performance.now(), _emscripten_get_now.sig = "d";
var reallyNegative = e => e < 0 || 0 === e && 1 / e == -1 / 0,
    convertI32PairToI53 = (e, r) => (e >>> 0) + 4294967296 * r,
    convertU32PairToI53 = (e, r) => (e >>> 0) + 4294967296 * (r >>> 0),
    reSign = (e, r) => {
        if (e <= 0) return e;
        var t = r <= 32 ? Math.abs(1 << r - 1) : Math.pow(2, r - 1);
        return e >= t && (r <= 32 || e > t) && (e = -2 * t + e), e
    },
    unSign = (e, r) => e >= 0 ? e : r <= 32 ? 2 * Math.abs(1 << r - 1) + e : Math.pow(2, r) + e,
    strLen = e => {
        for (var r = e; HEAPU8[r];) ++r;
        return r - e
    },
    formatString = (e, r) => {
        var t = e,
        ...
        function o(e) {
            ...
            }(n, e), "double" === e ? (r = HEAPF64[n >> 3], n += 8) : "i64" == e ? (r = [HEAP32[n >> 2], HEAP32[n + 4 >> 2]], n += 8) : (e = "i32", r = HEAP32[n >> 2], n += 4), r
        }
        for (var a, s, i, l = [];;) {
            var u = t;
            if (0 === (a = HEAP8[t | 0])) break;
            if (s = HEAP8[t + 1 | 0], 37 == a) {
                var c = !1,
                    d = !1,
                    m = !1,
                    _ = !1,
                ...
                var f = 0;
                if (42 == s) f = o("i32"), t++, s = HEAP8[t + 1 | 0];
                else
                    for (; s >= 48 && s <= 57;) f = 10 * f + (s - 48), t++, s = HEAP8[t + 1 | 0];
                var S, h = !1,
                    y = -1;
                if (46 == s) {
                    if (y = 0, h = !0, t++, 42 == (s = HEAP8[t + 1 | 0])) y = o("i32"), t++;
                    else
                        for (;;) {
                            var g = HEAP8[t + 1 | 0];
                            if (g < 48 || g > 57) break;
                ...
                switch (y < 0 && (y = 6, h = !1), String.fromCharCode(s)) {
                    case "h":
                        104 == HEAP8[t + 2 | 0] ? (t++, S = 1) : S = 2;
                        break;
                    case "l":
                        108 == HEAP8[t + 2 | 0] ? (t++, S = 8) : S = 4;
                        break;
                    case "L":
                    case "q":
                    case "j":
                ...
                switch (S && t++, s = HEAP8[t + 1 | 0], String.fromCharCode(s)) {
                    case "d":
                    case "i":
                    case "u":
                    case "o":
                    ...
                    case "p":
                        var E = 100 == s || 105 == s;
                        if (i = o("i" + 8 * (S = S || 4)), 8 == S && (i = 117 == s ? convertU32PairToI53(i[0], i[1]) : convertI32PairToI53(i[0], i[1])), S <= 4) {
                            var F = Math.pow(256, S) - 1;
                            i = (E ? reSign : unSign)(i & F, 8 * S)
                        }
                        var w = Math.abs(i),
                            v = "";
                        if (100 == s || 105 == s) M = reSign(i, 8 * S).toString(10);
                        else if (117 == s) M = unSign(i, 8 * S).toString(10), i = Math.abs(i);
                        else if (111 == s) M = (m ? "0" : "") + w.toString(8);
                        else if (120 == s || 88 == s) {
                            if (v = m && 0 != i ? "0x" : "", i < 0) {
                                i = -i, M = (w - 1).toString(16);
                                for (var b = [], A = 0; A < M.length; A++) b.push((15 - parseInt(M[A], 16)).toString(16));
                                for (M = b.join(""); M.length < 2 * S;) M = "f" + M
                            } else M = w.toString(16);
                            88 == s && (v = v.toUpperCase(), M = M.toUpperCase())
                        } else 112 == s && (0 === w ? M = "(nil)" : (v = "0x", M = w.toString(16)));
                        if (h)
                            for (; M.length < y;) M = "0" + M;
                        for (i >= 0 && (c ? v = "+" + v : p && (v = " " + v)), "-" == M.charAt(0) && (v = "-" + v, M = M.substr(1)); v.length + M.length < f;) d ? M += " " : _ ? M = "0" + M : v = " " + v;
                        (M = v + M).split("").forEach((function (e) {
                    ...
                    case "G":
                        var M;
                        if (i = o("double"), isNaN(i)) M = "nan", _ = !1;
                        else if (isFinite(i)) {
                            var k = !1,
                                P = Math.min(y, 20);
                            if (103 == s || 71 == s) {
                                k = !0, y = y || 1;
                                var T = parseInt(i.toExponential(P).split("e")[1], 10);
                                y > T && T >= -4 ? (s = (103 == s ? "f" : "F").charCodeAt(0), y -= T + 1) : (s = (103 == s ? "e" : "E").charCodeAt(0), y--), P = Math.min(y, 20)
                            }
                            101 == s || 69 == s ? (M = i.toExponential(P), /[eE][-+]\d$/.test(M) && (M = M.slice(0, -1) + "0" + M.slice(-1))) : 102 != s && 70 != s || (M = i.toFixed(P), 0 === i && reallyNegative(i) && (M = "-" + M));
                            var D = M.split("e");
                            if (k && !m)
                                for (; D[0].length > 1 && D[0].includes(".") && ("0" == D[0].slice(-1) || "." == D[0].slice(-1));) D[0] = D[0].slice(0, -1);
                            else
                                for (m && -1 == M.indexOf(".") && (D[0] += "."); y > P++;) D[0] += "0";
                            M = D[0] + (D.length > 1 ? "e" + D[1] : ""), 69 == s && (M = M.toUpperCase()), i >= 0 && (c ? M = "+" + M : p && (M = " " + M))
                        } else M = (i < 0 ? "-" : "") + "inf", _ = !1;
                        for (; M.length < f;) d ? M += " " : M = !_ || "-" != M[0] && "+" != M[0] ? (_ ? "0" : " ") + M : M[0] + "0" + M.slice(1);
                        s < 97 && (M = M.toUpperCase()), M.split("").forEach((function (e) {
                            l.push(e.charCodeAt(0))
                        }));
                        break;
                    case "s":
                        var H = o("i8*"),
                            L = H ? strLen(H) : 6;
                        if (h && (L = Math.min(L, y)), !d)
                            for (; L < f--;) l.push(32);
                        if (H)
                            for (A = 0; A < L; A++) l.push(HEAPU8[H++ | 0]);
                        else l = l.concat(intArrayFromString("(null)".substr(0, L), !0));
                        if (d)
                            for (; L < f--;) l.push(32);
                        break;
                    case "c":
                        for (d && l.push(o("i8")); --f > 0;) l.push(32);
                        d || l.push(o("i8"));
                        break;
                    case "n":
                        var C = o("i32*");
                    ...
                    case "%":
                        ...
                        break;
                    default:
                        for (A = u; A < t + 2; A++) l.push(HEAP8[A | 0])
                }
                t += 2
            } else l.push(a), t += 1
        }
...
function getCallstack(e) {
    var r = jsStackTrace(),
        ...
        o = r.indexOf("\n", Math.max(t, n)) + 1;
    r = r.slice(o), 8 & e && "undefined" == typeof emscripten_source_map && (warnOnce('Source map information is not available, emscripten_log with EM_LOG_C_STACK will be ignored. Build with "--pre-js $EMSCRIPTEN/src/emscripten-source-map.min.js" linker flag to add source map loading to code.'), e ^= 8, e |= 16);
    var a = r.split("\n");
    r = "";
    ...
    for (var u in a) {
        var c = a[u],
            ...
            p = 0,
            f = l.exec(c);
        if (f && 5 == f.length) d = f[1], m = f[2], _ = f[3], p = f[4];
        else {
            if ((f = s.exec(c)) || (f = i.exec(c)), !(f && f.length >= 4)) {
                r += c + "\n";
                continue
            }
            d = f[1], m = f[2], _ = f[3], p = 0 | f[4]
        }
        var S = !1;
        if (8 & e) {
            ...
            (S = h && h.source) && (64 & e && (h.source = h.source.substring(h.source.replace(/\\/g, "/").lastIndexOf("/") + 1)), r += `    at ${d} (${h.source}:${h.line}:${h.column})\n`)
        }(16 & e || !S) && (64 & e && (m = m.substring(m.replace(/\\/g, "/").lastIndexOf("/") + 1)), r += (S ? `     = ${d}` : `    at ${d}`) + ` (${m}:${_}:${p})\n`)
    }
    return r = r.replace(/\s+$/, "")
}
var emscriptenLog = (e, r) => {
        24 & e && (r = r.replace(/\s+$/, ""), r += (r.length > 0 ? "\n" : "") + getCallstack(e)), 1 & e ? 4 & e || 2 & e ? err(r) : out(r) : 6 & e ? err(r) : out(r)
    },
    _emscripten_log = (e, r, t) => {
        var n = formatString(r, t),
            o = UTF8ArrayToString(n, 0);
        emscriptenLog(e, o)
    };
...
var growMemory = e => {
    ...
    _emscripten_resize_heap = e => {
        ...
        for (var n, o, a = 1; a <= 4; a *= 2) {
            ...
            var i = Math.min(t, (n = Math.max(e, s)) + ((o = 65536) - n % o) % o);
            if (growMemory(i)) return !0
        }
        return !1
    };
_emscripten_resize_heap.sig = "ip";
var _emscripten_run_script = e => {
    eval(UTF8ToString(e))
};
_emscripten_run_script.sig = "vp";
var _emscripten_run_script_int = e => 0 | eval(UTF8ToString(e));
_emscripten_run_script_int.sig = "ip";
var _emscripten_run_script_string = e => {
    var r = eval(UTF8ToString(e));
    if (null == r) return 0;
    r += "";
    var t = _emscripten_run_script_string,
        n = lengthBytesUTF8(r);
    return (!t.bufferSize || t.bufferSize < n + 1) && (t.bufferSize && _free(t.buffer), t.bufferSize = n + 1, t.buffer = _malloc(t.bufferSize)), stringToUTF8(r, t.buffer, t.bufferSize), t.buffer
};
...
var ENV = {},
    ...
    getEnvStrings = () => {
        if (!getEnvStrings.strings) {
            ...
            for (var r in ENV) void 0 === ENV[r] ? delete e[r] : e[r] = ENV[r];
            var t = [];
    ...
    _environ_get = (e, r) => {
        ...
        return getEnvStrings().forEach(((n, o) => {
            var a = r + t;
            HEAPU32[e + 4 * o >> 2] = a, stringToAscii(n, a), t += n.length + 1
        })), 0
    };
...
var _environ_sizes_get = (e, r) => {
    ...
    var n = 0;
    return t.forEach((e => n += e.length + 1)), HEAPU32[r >> 2] = n, 0
};
...
function _fd_fdstat_get(e, r) {
    try {
        ...
        return HEAP8[r | 0] = n, HEAP16[r + 2 >> 1] = 0, tempI64 = [0, (tempDouble = 0, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + 8 >> 2] = tempI64[0], HEAP32[r + 12 >> 2] = tempI64[1], tempI64 = [0, (tempDouble = 0, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[r + 16 >> 2] = tempI64[0], HEAP32[r + 20 >> 2] = tempI64[1], 0
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name) throw e;
        return e.errno
    }
}
_environ_sizes_get.sig = "ipp", _fd_close.sig = "ii", _fd_fdstat_get.sig = "iip";
var doReadv = (e, r, t, n) => {
    for (var o = 0, a = 0; a < t; a++) {
        var s = HEAPU32[r >> 2],
            i = HEAPU32[r + 4 >> 2];
        r += 8;
        var l = FS.read(e, HEAP8, s, i, n);
        if (l < 0) return -1;
        if (o += l, l < i) break;
        void 0 !== n && (n += l)
    }
...
function _fd_seek(e, r, t, n, o) {
    ...
    try {
        ...
        return FS.llseek(s, a, n), tempI64 = [s.position >>> 0, (tempDouble = s.position, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], HEAP32[o >> 2] = tempI64[0], HEAP32[o + 4 >> 2] = tempI64[1], s.getdents && 0 === a && 0 === n && (s.getdents = null), 0
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name) throw e;
        return e.errno
    }
}
_fd_read.sig = "iippp", _fd_seek.sig = "iiiiip";
var doWritev = (e, r, t, n) => {
    for (var o = 0, a = 0; a < t; a++) {
        var s = HEAPU32[r >> 2],
            i = HEAPU32[r + 4 >> 2];
        r += 8;
        var l = FS.write(e, HEAP8, s, i, n);
        if (l < 0) return -1;
        o += l, void 0 !== n && (n += l)
    }
    return o
    ...
    _strftime = (e, r, t, n) => {
        ...
        function f(e) {
            var r = addDays(new Date(e.tm_year + 1900, 0, 1), e.tm_yday),
                ...
                o = p(t),
                a = p(n);
            return _(o, r) <= 0 ? _(a, r) <= 0 ? r.getFullYear() + 1 : r.getFullYear() : r.getFullYear() - 1
        }
        var S = {
            ...
            "%j": e => m(e.tm_mday + arraySum(isLeapYear(e.tm_year + 1900) ? MONTH_DAYS_LEAP : MONTH_DAYS_REGULAR, e.tm_mon - 1), 3),
            "%m": e => m(e.tm_mon + 1, 2),
            "%M": e => m(e.tm_min, 2),
            "%n": () => "\n",
            ...
            "%V": e => {
                ...
                if ((e.tm_wday + 371 - e.tm_yday - 2) % 7 <= 2 && r++, r) {
                    ...
                    (4 == n || 5 == n && isLeapYear(e.tm_year % 400 - 1)) && r++
                }
                return m(r, 2)
            },
            "%w": e => e.tm_wday,
        ...
        for (var l in s = s.replace(/%%/g, "\0\0"), S) s.includes(l) && (s = s.replace(new RegExp(l, "g"), S[l](a)));
        var h = intArrayFromString(s = s.replace(/\0\0/g, "%"), !1);
        return h.length > r ? 0 : (writeArrayToMemory(h, e), h.length - 1)
    };
_strftime.sig = "ppppp";
var _strftime_l = (e, r, t, n, o) => _strftime(e, r, t, n);
...
}), FS.FSNode = FSNode, FS.createPreloadedFile = FS_createPreloadedFile, FS.staticInit();
var wasmImports = {
    ...
    _setThrew = (e, r) => (_setThrew = wasmExports.setThrew)(e, r),
...
function callMain(e = []) {
    ...
    if (r) {
        ...
        var t = e.length,
            ...
            o = n;
        e.forEach((e => {
            HEAPU32[o >> 2] = stringToUTF8OnStack(e), o += 4
        })), HEAPU32[o >> 2] = 0;
        try {
            var a = r(t, n);
            return exitJS(a, !0), a
...
var shouldRunNow = !0;
Module.noInitialRun && (shouldRunNow = !1), run(), Module.loadDylibs = loadDylibs, Module.UTF8ToString = UTF8ToString, Module.loadDynamicLibrary = loadDynamicLibrary, Module._malloc = _malloc, Module._free = _free, Module.wasmImports = wasmImports, versions.std = {
    worker: "No Wroker",
    wasm: "1.2.0"
};