var Module = void 0 !== Module ? Module : {}, moduleOverrides = Object.assign({}, Module), arguments_ = [], thisProgram = "./this.program", quit_ = (e, r) => {
    throw r
}
, ENVIRONMENT_IS_WEB = !1, ENVIRONMENT_IS_WORKER = !0, ENVIRONMENT_IS_NODE = !1, scriptDirectory = "", read_, readAsync, readBinary;
...
var dynamicLibraries = Module.dynamicLibraries || [], wasmBinary;
Module.wasmBinary && (wasmBinary = Module.wasmBinary);
var noExitRuntime = Module.noExitRuntime || !0, wasmMemory;
...
function createWasm() {
    ...
    function r(e, r) {
        ...
        return t.neededDynlibs && (dynamicLibraries = t.neededDynlibs.concat(dynamicLibraries)),
...
, UTF8Decoder = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0, UTF8ArrayToString = (e, r, t) => {
    ...
    for (var a = ""; r < o; ) {
        ...
        if (128 & s) {
            ...
            if (192 != (224 & s)) {
                var l = 63 & e[r++];
                if ((s = 224 == (240 & s) ? (15 & s) << 12 | i << 6 | l : (7 & s) << 18 | i << 12 | l << 6 | 63 & e[r++]) < 65536)
...
, getDylinkMetadata = e => {
    ...
    if (e instanceof WebAssembly.Module) {
        ...
        0 === i.length && (s = "dylink",
        i = WebAssembly.Module.customSections(e, s)),
        a(0 === i.length, "need dylink section"),
        t = (e = new Uint8Array(i[0])).length
    } else {
        a(!(1836278016 == new Uint32Array(new Uint8Array(e.subarray(0, 24)).buffer)[0]), "need to see wasm magic number"),
...
, newDSO = (e, r, t) => {
    ...
    return LDSO.loadedLibsByName[e] = n,
    null != r && (LDSO.loadedLibsByHandle[r] = n),
    n
}
, LDSO = {
    loadedLibsByName: {},
...
}, ___heap_base = 113392, zeroMemory = (e, r) => (HEAPU8.fill(0, e, e + r),
e), alignMemory = (e, r) => Math.ceil(e / r) * r, getMemory = e => {
    if (runtimeInitialized)
        return zeroMemory(_malloc(e), e);
    var r = ___heap_base
      , t = r + alignMemory(e, 16);
    return ___heap_base = t,
    GOT.__heap_base.value = t,
    r
}
...
, convertJsFunctionToWasm = (e, r) => {
    if ("function" == typeof WebAssembly.Function)
        return new WebAssembly.Function(sigToWasmTypes(r),e);
    var t = [1];
    generateFuncType(r, t);
    var n = [0, 97, 115, 109, 1, 0, 0, 0, 1];
    uleb128Encode(t.length, n),
    n.push.apply(n, t),
...
, wasmTable = new WebAssembly.Table({
    initial: 456,
    element: "anyfunc"
}), getWasmTableEntry = e => wasmTable.get(e), updateTableMap = (e, r) => {
...
, functionsInTableMap, getFunctionAddress = e => (functionsInTableMap || (functionsInTableMap = new WeakMap,
updateTableMap(0, wasmTable.length)),
functionsInTableMap.get(e) || 0), freeTableIndexes = [], getEmptyTableSlot = () => {
...
, setWasmTableEntry = (e, r) => wasmTable.set(e, r), addFunction = (e, r) => {
...
, dynCall = (e, r, t) => e.includes("j") ? dynCallLegacy(e, r, t) : getWasmTableEntry(r).apply(null, t), createInvokeFunction = e => function() {
    var r = stackSave();
    try {
...
, resolveGlobalSymbol = (e, r=!1) => {
    var t;
    return r && "orig$" + e in wasmImports && (e = "orig$" + e),
    isSymbolDefined(e) ? t = wasmImports[e] : e.startsWith("invoke_") && (t = wasmImports[e] = createInvokeFunction(e.split("_")[1])),
    {
        sym: t,
        name: e
    }
}
, UTF8ToString = (e, r) => e ? UTF8ArrayToString(HEAPU8, e, r) : "", loadWebAssemblyModule = (e, r, t, n, o) => {
    ...
    function s() {
        ...
        if (t) {
            ...
            o && (HEAP8[o + 8 | 0] = 1,
            HEAPU32[o + 12 >> 2] = i,
            HEAP32[o + 16 >> 2] = a.memorySize,
            HEAPU32[o + 20 >> 2] = l,
            HEAP32[o + 24 >> 2] = a.tableSize)
        } else
            i = HEAPU32[o + 12 >> 2],
            l = HEAPU32[o + 20 >> 2];
        var u = l + a.tableSize - wasmTable.length, c;
        function d(e) {
        ...
        function f(e, t) {
            function n(e, r) {
                for (var t = [], n = 0; n < 16 && -1 != r.indexOf("$" + n); n++)
                    t.push("$" + n);
                t = t.join(",");
                var a = `(${t}) => { ${r} };`;
                ASM_CONSTS[o] = eval(a)
            }
            if (updateTableMap(l, a.tableSize),
            c = relocateExports(t.exports, i),
            r.allowUndefined || reportUndefinedSymbols(),
            "__start_em_asm"in c)
                for (var o = c.__start_em_asm, s = c.__stop_em_asm; o < s; ) {
                    var u = UTF8ToString(o);
                    n(o, u),
                    o = HEAPU8.indexOf(0, o) + 1
                }
            function d(e, r, t) {
                var n = [];
                if (r = r.slice(1, -1),
                "void" != r)
                    for (var o in r = r.split(","),
                    r) {
                        var a = r[o].split(" ").pop();
                        n.push(a.replace("*", ""))
                    }
    ...
    return currentModuleWeakSymbols = a.weakImports,
    r.loadAsync ? a.neededDynlibs.reduce(( (e, t) => e.then(( () => loadDynamicLibrary(t, r)))), Promise.resolve()).then(s) : (a.neededDynlibs.forEach((e => loadDynamicLibrary(e, r, n))),
    s())
}
, mergeLibSymbols = (e, r) => {
    for (var t in e) {
        ...
        "main" == t && r(n),
        t == n && r("main"),
        t.startsWith("dynCall_") && !Module.hasOwnProperty(t) && (Module[t] = e[t])
    }
}
, asyncLoad = (e, r, t, n) => {
    ...
    var e = {
        ...
        handle: (r, t, n, o) => {
            e.promiseChainEnd = e.promiseChainEnd.then(( () => loadWebAssemblyModule(r, {
                ...
                err(`failed to instantiate wasm: ${t}: ${e}`),
                o()
            }
            ))
        }
...
function loadDynamicLibrary(e, r={
    ...
    if (o)
        return r.global ? o.global || (o.global = !0,
        mergeLibSymbols(o.exports, e)) : t && Object.assign(t, o.exports),
        r.nodelete && o.refcount !== 1 / 0 && (o.refcount = 1 / 0),
        o.refcount++,
        n && (LDSO.loadedLibsByHandle[n] = o),
        !r.loadAsync || Promise.resolve(!0);
    function a() {
        if (n) {
        ...
        if (!readBinary)
            throw new Error(`${s}: file not found, and synchronous loading of external files is not available`);
        return readBinary(s)
    }
    function s() {
    ...
    function i(r) {
        o.global ? mergeLibSymbols(r, e) : t && Object.assign(t, r),
        o.exports = r
    }
    return (o = newDSO(e, n, "loading")).refcount = r.nodelete ? 1 / 0 : 1,
    o.global = r.global,
    r.loadAsync ? s().then((e => (i(e),
    !0))) : (i(s()),
    !0)
}
    ...
    for (var e in GOT)
        if (0 == GOT[e].value) {
            ...
            if ("function" == typeof r)
                GOT[e].value = addFunction(r, r.sig);
            else {
                if ("number" != typeof r)
...
var exceptionLast = 0
  ...
  , ___cxa_throw = (e, r, t) => {
    throw new ExceptionInfo(e).init(r, t),
...
var ___memory_base = new WebAssembly.Global({
  ...
  , PATH = {
    ...
    normalize: e => {
        var r = PATH.isAbs(e)
          , t = "/" === e.substr(-1);
        return (e = PATH.normalizeArray(e.split("/").filter((e => !!e)), !r).join("/")) || r || (e = "."),
        e && t && (e += "/"),
        (r ? "/" : "") + e
    }
    ,
  ...
  , lengthBytesUTF8 = e => {
    for (var r = 0, t = 0; t < e.length; ++t) {
        ...
        n <= 127 ? r++ : n <= 2047 ? r += 2 : n >= 55296 && n <= 57343 ? (r += 4,
        ++t) : r += 3
    }
    return r
}
...
var FS_stdin_getChar = () => {
    ...
    stream_ops: {
        ...
        write(e, r, t, n, o, a) {
            ...
            !n)
                return 0;
            var s = e.node;
            if (s.timestamp = Date.now(),
            r.subarray && (!s.contents || s.contents.subarray)) {
                if (a)
                    return s.contents = r.subarray(t, t + n),
                    s.usedBytes = n,
                    n;
                if (0 === s.usedBytes && 0 === o)
                    return s.contents = r.slice(t, t + n),
                    s.usedBytes = n,
                    n;
                if (o + n <= s.usedBytes)
                    return s.contents.set(r.subarray(t, t + n), o),
                    n
            }
            if (MEMFS.expandFileStorage(s, o + n),
            s.contents.subarray && r.subarray)
                s.contents.set(r.subarray(t, t + n), o);
            else
                for (var i = 0; i < n; i++)
                    s.contents[o + i] = r[t + i];
            return s.usedBytes = Math.max(s.usedBytes, o + n),
            n
        },
        llseek(e, r, t) {
            var n = r;
        ...
        mmap(e, r, t, n, o) {
            ...
            if (2 & o || i.buffer !== HEAP8.buffer) {
                if ((t > 0 || t + r < i.length) && (i = i.subarray ? i.subarray(t, t + r) : Array.prototype.slice.call(i, t, t + r)),
                s = !0,
                !(a = mmapAlloc(r)))
        ...
        msync: (e, r, t, n, o) => (MEMFS.stream_ops.write(e, r, 0, n, t, !1),
        0)
    }
}
  ...
  , FS_handledByPreloadPlugin = (e, r, t, n) => {
    ...
    return preloadPlugins.forEach((a => {
        o || a.canHandle(r) && (a.handle(e, r, t, n),
        o = !0)
    }
    )),
    o
  ...
  , FS_createPreloadedFile = (e, r, t, n, o, a, s, i, l, u) => {
    ...
    function m(t) {
        function m(t) {
            u && u(),
            i || FS_createDataFile(e, r, t, n, o, l),
            a && a(),
    ...
    addRunDependency(d),
    "string" == typeof t ? asyncLoad(t, (e => m(e)), s) : m(t)
}
  ...
  , FS = {
    ...
    lookupPath(e, r={}) {
        ...
        for (var t = e.split("/").filter((e => !!e)), n = FS.root, o = "/", a = 0; a < t.length; a++) {
            ...
            if (s && r.parent)
                break;
            if (n = FS.lookupNode(n, t[a]),
            o = PATH.join2(o, t[a]),
            FS.isMountpoint(n) && (!s || s && r.follow_mount) && (n = n.mounted.root),
            !s || r.follow)
                for (var i = 0; FS.isLink(n.mode); ) {
                    var l = FS.readlink(o);
                    if (o = PATH_FS.resolve(PATH.dirname(o), l),
                    n = FS.lookupPath(o, {
    ...
    mount(e, r, t) {
        ...
        return l.mount = i,
        i.root = l,
        o ? FS.root = l : n && (n.mounted = i,
        n.mount && n.mount.mounts.push(i)),
        l
    },
    unmount(e) {
        ...
        Object.keys(FS.nameTable).forEach((e => {
            for (var r = FS.nameTable[e]; r; ) {
                var t = r.name_next;
                o.includes(r.mount) && FS.destroyNode(r),
                r = t
            }
        }
        )),
    ...
    rename(e, r) {
        var t, n, o = PATH.dirname(e), a = PATH.dirname(r), s = PATH.basename(e), i = PATH.basename(r);
        ...
        var l, u = FS.lookupNode(t, s), c = PATH_FS.relative(e, a);
        if ("." !== c.charAt(0))
            throw new FS.ErrnoError(28);
        ...
        if (u !== l) {
            ...
            if (m = l ? FS.mayDelete(n, i, d) : FS.mayCreate(n, i))
                throw new FS.ErrnoError(m);
    ...
    open(e, r, t) {
        ...
        var n;
        if (t = void 0 === t ? 438 : t,
        t = 64 & (r = "string" == typeof r ? FS_modeStringToFlags(r) : r) ? 4095 & t | 32768 : 0,
        "object" == typeof e)
            n = e;
        else {
            e = PATH.normalize(e);
    ...
    createDefaultDevices() {
        ...
        var e = new Uint8Array(1024)
          , r = 0
          , t = () => (0 === r && (r = randomFill(e).byteLength),
        e[--r]);
    ...
    createDataFile(e, r, t, n, o, a) {
        var s = r;
        e && (e = "string" == typeof e ? e : FS.getPath(e),
        s = r ? PATH.join2(e, r) : e);
        var i = FS_getMode(n, o)
          , l = FS.create(s, i);
        if (t) {
            if ("string" == typeof t) {
                for (var u = new Array(t.length), c = 0, d = t.length; c < d; ++c)
                    u[c] = t.charCodeAt(c);
                t = u
            }
            FS.chmod(l, 146 | i);
            var m = FS.open(l, 577);
            FS.write(m, t, 0, t.length, 0, a),
            FS.close(m),
            FS.chmod(l, i)
        }
        return l
    ...
    createLazyFile(e, r, t, n, o) {
        ...
        a.prototype.cacheLength = function() {
            ...
            i.setDataGetter((e => {
                var r = e * s
                  , o = (e + 1) * s - 1;
                if (o = Math.min(o, n - 1),
                void 0 === i.chunks[e] && (i.chunks[e] = ( (e, r) => {
                    if (e > r)
        ...
        i.contents ? l.contents = i.contents : i.url && (l.contents = null,
        l.url = i.url),
        ...
        return Object.keys(l.stream_ops).forEach((e => {
            ...
            u[e] = function() {
                return FS.forceLoadFile(l),
                r.apply(null, arguments)
            }
        }
        )),
        u.read = (e, r, t, n, o) => (FS.forceLoadFile(l),
        c(e, r, t, n, o)),
        u.mmap = (e, r, t, n, o) => {
            FS.forceLoadFile(l);
            var a = mmapAlloc(r);
  ...
  , SYSCALLS = {
    ...
    calculateAt(e, r, t) {
        if (PATH.isAbs(r))
            return r;
        var n;
        -100 === e ? n = FS.cwd() : n = SYSCALLS.getStreamFromFD(e).path;
        if (0 == r.length) {
            if (!t)
                throw new FS.ErrnoError(44);
            return n
    ...
    doStat(e, r, t) {
        ...
        var o = n.atime.getTime()
          , a = n.mtime.getTime()
          , s = n.ctime.getTime();
        return tempI64 = [Math.floor(o / 1e3) >>> 0, (tempDouble = Math.floor(o / 1e3),
        +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
        ...
        tempI64 = [Math.floor(s / 1e3) >>> 0, (tempDouble = Math.floor(s / 1e3),
        +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
        HEAP32[t + 72 >> 2] = tempI64[0],
        HEAP32[t + 76 >> 2] = tempI64[1],
        HEAPU32[t + 80 >> 2] = s % 1e3 * 1e3,
        ...
        for (var a = 0, s = r ? HEAP32[r >> 2] : 0, i = r ? HEAP32[r + 4 >> 2] : 0, l = t ? HEAP32[t >> 2] : 0, u = t ? HEAP32[t + 4 >> 2] : 0, c = n ? HEAP32[n >> 2] : 0, d = n ? HEAP32[n + 4 >> 2] : 0, m = 0, _ = 0, p = 0, f = 0, S = 0, h = 0, y = (r ? HEAP32[r >> 2] : 0) | (t ? HEAP32[t >> 2] : 0) | (n ? HEAP32[n >> 2] : 0), g = (r ? HEAP32[r + 4 >> 2] : 0) | (t ? HEAP32[t + 4 >> 2] : 0) | (n ? HEAP32[n + 4 >> 2] : 0), E = function(e, r, t, n) {
            ...
            if (E(F, y, g, w)) {
                ...
                if (v.stream_ops.poll) {
                    var A = -1;
                    if (o)
                        A = 1e3 * ((r ? HEAP32[o >> 2] : 0) + (r ? HEAP32[o + 8 >> 2] : 0) / 1e6);
                    b = v.stream_ops.poll(v, A)
                }
                1 & b && E(F, s, i, w) && (F < 32 ? m |= w : _ |= w,
                a++),
                4 & b && E(F, l, u, w) && (F < 32 ? p |= w : f |= w,
                a++),
                2 & b && E(F, c, d, w) && (F < 32 ? S |= w : h |= w,
                a++)
            }
        }
        return r && (HEAP32[r >> 2] = m,
        HEAP32[r + 4 >> 2] = _),
        t && (HEAP32[t >> 2] = p,
        HEAP32[t + 4 >> 2] = f),
        n && (HEAP32[n >> 2] = S,
...
var SOCKFS = {
    mount: e => (Module.websocket = Module.websocket && "object" == typeof Module.websocket ? Module.websocket : {},
    Module.websocket._callbacks = {},
    Module.websocket.on = function(e, r) {
        return "function" == typeof r && (this._callbacks[e] = r),
        this
    }
    ,
    ...
    nextname: () => (SOCKFS.nextname.current || (SOCKFS.nextname.current = 0),
    "socket[" + SOCKFS.nextname.current++ + "]"),
    websocket_sock_ops: {
        createPeer(e, r, t) {
            var n;
            if ("object" == typeof r && (n = r,
            r = null,
            t = null),
            n)
                if (n._socket)
                ...
                try {
                    var a = Module.websocket && "object" == typeof Module.websocket
                      , s = "ws:#".replace("#", "//");
                    if (a && "string" == typeof Module.websocket.url && (s = Module.websocket.url),
                    "ws://" === s || "wss://" === s) {
                        var i = r.split("/");
                    ...
                    var u = void 0;
                    "null" !== l && (u = l = l.replace(/^ +| +$/g, "").split(/ *, */)),
                    a && null === Module.websocket.subprotocol && (l = "null",
                    u = void 0),
                    (n = new WebSocket(s,u)).binaryType = "arraybuffer"
                } catch (e) {
            ...
            return SOCKFS.websocket_sock_ops.addPeer(e, c),
            SOCKFS.websocket_sock_ops.handlePeerEvents(e, c),
        ...
        handlePeerEvents(e, r) {
            ...
            function o(n) {
                ...
                var o = t;
                if (t = !1,
                o && 10 === n.length && 255 === n[0] && 255 === n[1] && 255 === n[2] && 255 === n[3] && n[4] === "p".charCodeAt(0) && n[5] === "o".charCodeAt(0) && n[6] === "r".charCodeAt(0) && n[7] === "t".charCodeAt(0)) {
                    var a = n[8] << 8 | n[9];
            ...
            ENVIRONMENT_IS_NODE ? (r.socket.on("open", n),
        ...
        sendmsg(e, r, t, n, o, a) {
            if (2 === e.type) {
                if (void 0 !== o && void 0 !== a || (o = e.daddr,
                a = e.dport),
                void 0 === o || void 0 === a)
            ...
            if (ArrayBuffer.isView(r) && (t += r.byteOffset,
            r = r.buffer),
            s = r.slice(t, t + n),
            2 === e.type && (!i || i.socket.readyState !== i.socket.OPEN))
                return i && i.socket.readyState !== i.socket.CLOSING && i.socket.readyState !== i.socket.CLOSED || (i = SOCKFS.websocket_sock_ops.createPeer(e, o, a)),
                i.dgram_send_queue.push(s),
                n;
            try {
                return i.socket.send(s),
                n
            } catch (e) {
                throw new FS.ErrnoError(28)
            }
  ...
  , setErrNo = e => (HEAP32[___errno_location() >> 2] = e,
e)
  ...
  , inetNtop6 = e => {
    ...
    for (t = 0; t < 8; t++)
        ...
        s > n && (a = t - (n = s) + 1);
    for (t = 0; t < 8; t++)
        n > 1 && 0 === l[t] && t >= a && t < a + n ? t === a && (r += ":",
        0 === a && (r += ":")) : (r += Number(_ntohs(65535 & l[t])).toString(16),
        r += t < 7 ? ":" : "");
    return r
}
  , readSockaddr = (e, r) => {
    var t, n = HEAP16[e >> 1], o = _ntohs(HEAPU16[e + 2 >> 1]);
    switch (n) {
    case 2:
        if (16 !== r)
            return {
    ...
    case 10:
        ...
        t = [HEAP32[e + 8 >> 2], HEAP32[e + 12 >> 2], HEAP32[e + 16 >> 2], HEAP32[e + 20 >> 2]],
        t = inetNtop6(t);
        break;
    default:
        return {
  ...
  , inetPton6 = e => {
    ...
    for ((e = e.startsWith("::") ? e.replace("::", "Z:") : e.replace("::", ":Z:")).indexOf(".") > 0 ? ((r = (e = e.replace(new RegExp("[.]","g"), ":")).split(":"))[r.length - 4] = jstoi_q(r[r.length - 4]) + 256 * jstoi_q(r[r.length - 3]),
    r[r.length - 3] = jstoi_q(r[r.length - 2]) + 256 * jstoi_q(r[r.length - 1]),
    r = r.slice(0, r.length - 2)) : r = e.split(":"),
    n = 0,
    o = 0,
    t = 0; t < r.length; t++)
...
function ___syscall_connect(e, r, t, n, o, a) {
    try {
        ...
        return s.sock_ops.connect(s, i.addr, i.port),
        0
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name)
            throw e;
...
function ___syscall_ftruncate64(e, r, t) {
    ...
    try {
        return isNaN(n) ? 61 : (FS.ftruncate(e, n),
        0)
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name)
            throw e;
    ...
    try {
        ...
        for (var o = 280, a = 0, s = FS.llseek(n, 0, 1), i = Math.floor(s / o); i < n.getdents.length && a + o <= t; ) {
            ...
            if ("." === c)
                ...
                l = d.id,
                u = FS.isChrdev(d.mode) ? 2 : FS.isDir(d.mode) ? 4 : FS.isLink(d.mode) ? 10 : 8
            }
            tempI64 = [l >>> 0, (tempDouble = l,
            +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
            HEAP32[r + a >> 2] = tempI64[0],
            HEAP32[r + a + 4 >> 2] = tempI64[1],
            tempI64 = [(i + 1) * o >>> 0, (tempDouble = (i + 1) * o,
            +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
            HEAP32[r + a + 8 >> 2] = tempI64[0],
            HEAP32[r + a + 12 >> 2] = tempI64[1],
            HEAP16[r + a + 16 >> 1] = 280,
            HEAP8[r + a + 18 | 0] = u,
            stringToUTF8(c, r + a + 19, 256),
            a += o,
            i += 1
        }
        return FS.llseek(n, i * o, 0),
        a
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name)
            throw e;
...
function ___syscall_mkdirat(e, r, t) {
    try {
        return r = SYSCALLS.getStr(r),
        r = SYSCALLS.calculateAt(e, r),
        "/" === (r = PATH.normalize(r))[r.length - 1] && (r = r.substr(0, r.length - 1)),
        FS.mkdir(r, t, 0),
        0
    } catch (e) {
        if (void 0 === FS || "ErrnoError" !== e.name)
...
var stringToNewUTF8 = e => {
  ...
  , __tzset_js = (e, r, t) => {
    ...
    HEAPU32[e >> 2] = 60 * l,
    HEAP32[r >> 2] = Number(s != i);
    var c = u(o)
      , d = u(a)
      , m = stringToNewUTF8(c)
      , _ = stringToNewUTF8(d);
    i < s ? (HEAPU32[t >> 2] = m,
    HEAPU32[t + 4 >> 2] = _) : (HEAPU32[t >> 2] = _,
    HEAPU32[t + 4 >> 2] = m)
}
;
__tzset_js.sig = "vppp";
...
var getHeapMax = () => 2147483648, _emscripten_get_heap_max = () => getHeapMax(), _emscripten_get_now;
  ...
  , formatString = (e, r) => {
    ...
    function o(e) {
        ...
        return n = function(e, r) {
            return "double" !== r && "i64" !== r || 7 & e && (e += 4),
            e
        }(n, e),
        "double" === e ? (r = HEAPF64[n >> 3],
        n += 8) : "i64" == e ? (r = [HEAP32[n >> 2], HEAP32[n + 4 >> 2]],
        n += 8) : (e = "i32",
        r = HEAP32[n >> 2],
        n += 4),
        r
    ...
    for (var a, s, i, l = []; ; ) {
        ...
        37 == a) {
            ...
            case "p":
                var E = 100 == s || 105 == s;
                if (i = o("i" + 8 * (S = S || 4)),
                8 == S && (i = 117 == s ? convertU32PairToI53(i[0], i[1]) : convertI32PairToI53(i[0], i[1])),
                S <= 4) {
                ...
                var w = Math.abs(i)
                  , v = "";
                if (100 == s || 105 == s)
                    M = reSign(i, 8 * S).toString(10);
                else if (117 == s)
                    M = unSign(i, 8 * S).toString(10),
                    i = Math.abs(i);
                else if (111 == s)
                    M = (m ? "0" : "") + w.toString(8);
                else if (120 == s || 88 == s) {
                    ...
                    i < 0) {
                        ...
                        for (var b = [], A = 0; A < M.length; A++)
                            b.push((15 - parseInt(M[A], 16)).toString(16));
                        for (M = b.join(""); M.length < 2 * S; )
                            M = "f" + M
                    } else
                        M = w.toString(16);
                    88 == s && (v = v.toUpperCase(),
                    M = M.toUpperCase())
                } else
                    112 == s && (0 === w ? M = "(nil)" : (v = "0x",
                    M = w.toString(16)));
                if (h)
                    for (; M.length < y; )
                        M = "0" + M;
                for (i >= 0 && (c ? v = "+" + v : p && (v = " " + v)),
                "-" == M.charAt(0) && (v = "-" + v,
                M = M.substr(1)); v.length + M.length < f; )
                    d ? M += " " : _ ? M = "0" + M : v = " " + v;
            ...
            case "G":
                ...
                isNaN(i))
                    ...
                    if (103 == s || 71 == s) {
                        ...
                        y > T && T >= -4 ? (s = (103 == s ? "f" : "F").charCodeAt(0),
                        y -= T + 1) : (s = (103 == s ? "e" : "E").charCodeAt(0),
                        y--),
                        P = Math.min(y, 20)
                    }
                    101 == s || 69 == s ? (M = i.toExponential(P),
                    /[eE][-+]\d$/.test(M) && (M = M.slice(0, -1) + "0" + M.slice(-1))) : 102 != s && 70 != s || (M = i.toFixed(P),
                    0 === i && reallyNegative(i) && (M = "-" + M));
                    var D = M.split("e");
                    if (k && !m)
                        for (; D[0].length > 1 && D[0].includes(".") && ("0" == D[0].slice(-1) || "." == D[0].slice(-1)); )
                            D[0] = D[0].slice(0, -1);
                    else
                        for (m && -1 == M.indexOf(".") && (D[0] += "."); y > P++; )
                            D[0] += "0";
                    M = D[0] + (D.length > 1 ? "e" + D[1] : ""),
                    69 == s && (M = M.toUpperCase()),
                    i >= 0 && (c ? M = "+" + M : p && (M = " " + M))
                } else
                    M = (i < 0 ? "-" : "") + "inf",
                    _ = !1;
                for (; M.length < f; )
                    d ? M += " " : M = !_ || "-" != M[0] && "+" != M[0] ? (_ ? "0" : " ") + M : M[0] + "0" + M.slice(1);
                s < 97 && (M = M.toUpperCase()),
            ...
            case "s":
                ...
                if (H)
                    ...
                    l = l.concat(intArrayFromString("(null)".substr(0, L), !0));
                if (d)
                    for (; L < f--; )
                        l.push(32);
                break;
            case "c":
                for (d && l.push(o("i8")); --f > 0; )
                    l.push(32);
                d || l.push(o("i8"));
                break;
            case "n":
...
function getCallstack(e) {
    ...
    for (var u in a) {
        ...
        if (8 & e) {
            ...
            (S = h && h.source) && (64 & e && (h.source = h.source.substring(h.source.replace(/\\/g, "/").lastIndexOf("/") + 1)),
            r += `    at ${d} (${h.source}:${h.line}:${h.column})\n`)
        }
        (16 & e || !S) && (64 & e && (m = m.substring(m.replace(/\\/g, "/").lastIndexOf("/") + 1)),
        r += (S ? `     = ${d}` : `    at ${d}`) + ` (${m}:${_}:${p})\n`)
    }
...
var emscriptenLog = (e, r) => {
    24 & e && (r = r.replace(/\s+$/, ""),
    r += (r.length > 0 ? "\n" : "") + getCallstack(e)),
    1 & e ? 4 & e || 2 & e ? err(r) : out(r) : 6 & e ? err(r) : out(r)
}
...
var _emscripten_run_script_string = e => {
    ...
    var t = _emscripten_run_script_string
      , n = lengthBytesUTF8(r);
    return (!t.bufferSize || t.bufferSize < n + 1) && (t.bufferSize && _free(t.buffer),
    t.bufferSize = n + 1,
    t.buffer = _malloc(t.bufferSize)),
    stringToUTF8(r, t.buffer, t.bufferSize),
    t.buffer
}
;
...
var _environ_sizes_get = (e, r) => {
    ...
    var n = 0;
    return t.forEach((e => n += e.length + 1)),
    HEAPU32[r >> 2] = n,
    0
}
;
...
function _fd_seek(e, r, t, n, o) {
    ...
    try {
        ...
        return FS.llseek(s, a, n),
        tempI64 = [s.position >>> 0, (tempDouble = s.position,
        +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
...
var arraySum = (e, r) => {
  ...
  , _strftime = (e, r, t, n) => {
    ...
    for (var l in i)
        s = s.replace(new RegExp(l,"g"), i[l]);
    ...
    for (var l in s = s.replace(/%%/g, "\0\0"),
    S)
        s.includes(l) && (s = s.replace(new RegExp(l,"g"), S[l](a)));
...
var _proc_exit = e => {
    EXITSTATUS = e,
    keepRuntimeAlive() || (Module.onExit && Module.onExit(e),
    ABORT = !0),
...
}, wasmExports = createWasm(), ___errno_location = () => (___errno_location = wasmExports.__errno_location)(), _malloc = Module._malloc = e => (_malloc = Module._malloc = wasmExports.malloc)(e), _free = Module._free = e => (_free = Module._free = wasmExports.free)(e), _setThrew = (e, r) => (_setThrew = wasmExports.setThrew)(e, r), stackSave = () => (stackSave = wasmExports.stackSave)(), stackRestore = e => (stackRestore = wasmExports.stackRestore)(e), stackAlloc = e => (stackAlloc = wasmExports.stackAlloc)(e), calledRun;
function callMain(e=[]) {
